...
umain(int argc, char **argv)
{
  ...
  800075:	c7 44 24 08 86 2c 80 	movl   $0x802c86,0x8(%esp)
  80007c:	00 
  80007d:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  800084:	00 
  800085:	c7 04 24 a0 2c 80 00 	movl   $0x802ca0,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800120:	c7 04 24 c0 2c 80 00 	movl   $0x802cc0,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002e8:	0f be 80 e3 2c 80 00 	movsbl 0x802ce3(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8004af:	c7 44 24 08 fb 2c 80 	movl   $0x802cfb,0x8(%esp)
  8004b6:	00 
  ...
  800501:	b8 f4 2c 80 00       	mov    $0x802cf4,%eax
