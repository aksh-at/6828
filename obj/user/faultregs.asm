...
pgfault(struct UTrapframe *utf)
{
  ...
  800425:	c7 44 24 04 df 16 80 	movl   $0x8016df,0x4(%esp)
  80042c:	00 
  80042d:	c7 04 24 ed 16 80 00 	movl   $0x8016ed,(%esp)
  800434:	b9 60 20 80 00       	mov    $0x802060,%ecx
  800439:	ba d8 16 80 00       	mov    $0x8016d8,%edx
  ...
  80046c:	c7 44 24 08 f4 16 80 	movl   $0x8016f4,0x8(%esp)
  800473:	00 
  800474:	c7 44 24 04 5c 00 00 	movl   $0x5c,0x4(%esp)
  80047b:	00 
  80047c:	c7 04 24 c7 16 80 00 	movl   $0x8016c7,(%esp)
...
umain(int argc, char **argv)
{
  ...
  800560:	c7 04 24 54 17 80 00 	movl   $0x801754,(%esp)
  ...
  800576:	c7 44 24 04 07 17 80 	movl   $0x801707,0x4(%esp)
  80057d:	00 
  80057e:	c7 04 24 18 17 80 00 	movl   $0x801718,(%esp)
  800585:	b9 20 20 80 00       	mov    $0x802020,%ecx
  80058a:	ba d8 16 80 00       	mov    $0x8016d8,%edx
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800623:	c7 04 24 80 17 80 00 	movl   $0x801780,(%esp)
  ...
  800639:	e8 51 00 00 00       	call   80068f <vcprintf>
	cprintf("\n");
  80063e:	c7 04 24 90 16 80 00 	movl   $0x801690,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80077f:	e8 3c 0c 00 00       	call   8013c0 <__udivdi3>
  ...
  8007df:	e8 0c 0d 00 00       	call   8014f0 <__umoddi3>
...
sys_env_destroy(envid_t envid)
{
  ...
  8010d0:	00 
  8010d1:	c7 44 24 08 e4 19 80 	movl   $0x8019e4,0x8(%esp)
  8010d8:	00 
  8010d9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8010e0:	00 
  8010e1:	c7 04 24 01 1a 80 00 	movl   $0x801a01,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  801162:	00 
  801163:	c7 44 24 08 e4 19 80 	movl   $0x8019e4,0x8(%esp)
  80116a:	00 
  80116b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801172:	00 
  801173:	c7 04 24 01 1a 80 00 	movl   $0x801a01,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8011b5:	00 
  8011b6:	c7 44 24 08 e4 19 80 	movl   $0x8019e4,0x8(%esp)
  8011bd:	00 
  8011be:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8011c5:	00 
  8011c6:	c7 04 24 01 1a 80 00 	movl   $0x801a01,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  801208:	00 
  801209:	c7 44 24 08 e4 19 80 	movl   $0x8019e4,0x8(%esp)
  801210:	00 
  801211:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801218:	00 
  801219:	c7 04 24 01 1a 80 00 	movl   $0x801a01,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80125b:	00 
  80125c:	c7 44 24 08 e4 19 80 	movl   $0x8019e4,0x8(%esp)
  801263:	00 
  801264:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80126b:	00 
  80126c:	c7 04 24 01 1a 80 00 	movl   $0x801a01,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8012ae:	00 
  8012af:	c7 44 24 08 e4 19 80 	movl   $0x8019e4,0x8(%esp)
  8012b6:	00 
  8012b7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8012be:	00 
  8012bf:	c7 04 24 01 1a 80 00 	movl   $0x801a01,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  801323:	00 
  801324:	c7 44 24 08 e4 19 80 	movl   $0x8019e4,0x8(%esp)
  80132b:	00 
  80132c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801333:	00 
  801334:	c7 04 24 01 1a 80 00 	movl   $0x801a01,(%esp)
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  80134f:	83 3d d0 20 80 00 00 	cmpl   $0x0,0x8020d0
  801356:	75 2f                	jne    801387 <set_pgfault_handler+0x3f>
		// First time through!
		// LAB 4: Your code here.
		envid_t envid = sys_getenvid();
  801358:	e8 98 fd ff ff       	call   8010f5 <sys_getenvid>
  ...
  801377:	c7 44 24 04 95 13 80 	movl   $0x801395,0x4(%esp)
  80137e:	00 
  80137f:	89 1c 24             	mov    %ebx,(%esp)
  801382:	e8 f9 fe ff ff       	call   801280 <sys_env_set_pgfault_upcall>
	}

	// Save handler pointer for assembly to call.
	_pgfault_handler = handler;
  801387:	8b 45 08             	mov    0x8(%ebp),%eax
  80138a:	a3 d0 20 80 00       	mov    %eax,0x8020d0
}
...
_pgfault_upcall:
  ...
  801396:	a1 d0 20 80 00       	mov    0x8020d0,%eax
	call *%eax
  ...
  8013a0:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
	movl 0x30(%esp), %eax 
  8013a5:	8b 44 24 30          	mov    0x30(%esp),%eax
	movl 0x28(%esp), %ebp
  8013a9:	8b 6c 24 28          	mov    0x28(%esp),%ebp
	movl %ebp, (%eax)
  8013ad:	89 28                	mov    %ebp,(%eax)
