...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 18             	sub    $0x18,%esp
	cprintf("hello, world\n");
  800039:	c7 04 24 e0 25 80 00 	movl   $0x8025e0,(%esp)
  ...
  800051:	c7 04 24 ee 25 80 00 	movl   $0x8025ee,(%esp)
...
exit(void)
{
  ...
  8000aa:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000ad:	e8 f8 0f 00 00       	call   8010aa <close_all>
	sys_env_destroy(0);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800258:	0f be 80 0f 26 80 00 	movsbl 0x80260f(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800373:	ff 24 8d 60 27 80 00 	jmp    *0x802760(,%ecx,4)
  ...
  80043f:	c7 44 24 08 f5 29 80 	movl   $0x8029f5,0x8(%esp)
  800446:	00 
  ...
  800471:	b8 20 26 80 00       	mov    $0x802620,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b40:	00 
  800b41:	c7 44 24 08 1f 29 80 	movl   $0x80291f,0x8(%esp)
  800b48:	00 
  800b49:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b50:	00 
  800b51:	c7 04 24 3c 29 80 00 	movl   $0x80293c,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bd2:	00 
  800bd3:	c7 44 24 08 1f 29 80 	movl   $0x80291f,0x8(%esp)
  800bda:	00 
  800bdb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800be2:	00 
  800be3:	c7 04 24 3c 29 80 00 	movl   $0x80293c,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c25:	00 
  800c26:	c7 44 24 08 1f 29 80 	movl   $0x80291f,0x8(%esp)
  800c2d:	00 
  800c2e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c35:	00 
  800c36:	c7 04 24 3c 29 80 00 	movl   $0x80293c,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c78:	00 
  800c79:	c7 44 24 08 1f 29 80 	movl   $0x80291f,0x8(%esp)
  800c80:	00 
  800c81:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c88:	00 
  800c89:	c7 04 24 3c 29 80 00 	movl   $0x80293c,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800ccb:	00 
  800ccc:	c7 44 24 08 1f 29 80 	movl   $0x80291f,0x8(%esp)
  800cd3:	00 
  800cd4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cdb:	00 
  800cdc:	c7 04 24 3c 29 80 00 	movl   $0x80293c,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d1e:	00 
  800d1f:	c7 44 24 08 1f 29 80 	movl   $0x80291f,0x8(%esp)
  800d26:	00 
  800d27:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d2e:	00 
  800d2f:	c7 04 24 3c 29 80 00 	movl   $0x80293c,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d71:	00 
  800d72:	c7 44 24 08 1f 29 80 	movl   $0x80291f,0x8(%esp)
  800d79:	00 
  800d7a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d81:	00 
  800d82:	c7 04 24 3c 29 80 00 	movl   $0x80293c,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800de6:	00 
  800de7:	c7 44 24 08 1f 29 80 	movl   $0x80291f,0x8(%esp)
  800dee:	00 
  800def:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800df6:	00 
  800df7:	c7 04 24 3c 29 80 00 	movl   $0x80293c,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800fbf:	8b 04 95 c8 29 80 00 	mov    0x8029c8(,%edx,4),%eax
  ...
  800fca:	a1 08 40 80 00       	mov    0x804008,%eax
  800fcf:	8b 40 48             	mov    0x48(%eax),%eax
  800fd2:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  800fd6:	89 44 24 04          	mov    %eax,0x4(%esp)
  800fda:	c7 04 24 4c 29 80 00 	movl   $0x80294c,(%esp)
  800fe1:	e8 7d f1 ff ff       	call   800163 <cprintf>
	*dev = 0;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80122f:	c7 04 24 8d 29 80 00 	movl   $0x80298d,(%esp)
  801236:	e8 28 ef ff ff       	call   800163 <cprintf>
		return -E_INVAL;
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801307:	c7 04 24 a9 29 80 00 	movl   $0x8029a9,(%esp)
  80130e:	e8 50 ee ff ff       	call   800163 <cprintf>
		return -E_INVAL;
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8013ae:	75 23                	jne    8013d3 <ftruncate+0x63>
		cprintf("[%08x] ftruncate %d -- bad mode\n",
			thisenv->env_id, fdnum);
  8013b0:	a1 08 40 80 00       	mov    0x804008,%eax
	struct Fd *fd;
	if ((r = fd_lookup(fdnum, &fd)) < 0
	    || (r = dev_lookup(fd->fd_dev_id, &dev)) < 0)
		return r;
  ...
  8013c0:	c7 04 24 6c 29 80 00 	movl   $0x80296c,(%esp)
  8013c7:	e8 97 ed ff ff       	call   800163 <cprintf>
			thisenv->env_id, fdnum);
		return -E_INVAL;
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801644:	c7 44 24 0c dc 29 80 	movl   $0x8029dc,0xc(%esp)
  80164b:	00 
  80164c:	c7 44 24 08 e3 29 80 	movl   $0x8029e3,0x8(%esp)
  801653:	00 
  801654:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  80165b:	00 
  80165c:	c7 04 24 f8 29 80 00 	movl   $0x8029f8,(%esp)
  801663:	e8 1e 0b 00 00       	call   802186 <_panic>
	assert(r <= PGSIZE);
  801668:	3d 00 10 00 00       	cmp    $0x1000,%eax
  80166d:	7e 24                	jle    801693 <devfile_read+0x84>
  80166f:	c7 44 24 0c 03 2a 80 	movl   $0x802a03,0xc(%esp)
  801676:	00 
  801677:	c7 44 24 08 e3 29 80 	movl   $0x8029e3,0x8(%esp)
  80167e:	00 
  80167f:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  801686:	00 
  801687:	c7 04 24 f8 29 80 00 	movl   $0x8029f8,(%esp)
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801756:	c7 44 24 04 0f 2a 80 	movl   $0x802a0f,0x4(%esp)
  80175d:	00 
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801b77:	c7 44 24 0c 1b 2a 80 	movl   $0x802a1b,0xc(%esp)
  801b7e:	00 
  801b7f:	c7 44 24 08 e3 29 80 	movl   $0x8029e3,0x8(%esp)
  801b86:	00 
  801b87:	c7 44 24 04 62 00 00 	movl   $0x62,0x4(%esp)
  801b8e:	00 
  801b8f:	c7 04 24 30 2a 80 00 	movl   $0x802a30,(%esp)
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801bd5:	c7 44 24 0c 3c 2a 80 	movl   $0x802a3c,0xc(%esp)
  801bdc:	00 
  801bdd:	c7 44 24 08 e3 29 80 	movl   $0x8029e3,0x8(%esp)
  801be4:	00 
  801be5:	c7 44 24 04 6d 00 00 	movl   $0x6d,0x4(%esp)
  801bec:	00 
  801bed:	c7 04 24 30 2a 80 00 	movl   $0x802a30,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801c70:	c7 44 24 04 48 2a 80 	movl   $0x802a48,0x4(%esp)
  801c77:	00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801d13:	0f b6 c2             	movzbl %dl,%eax
		nn = thisenv->env_runs;
  801d16:	8b 0d 08 40 80 00    	mov    0x804008,%ecx
  ...
  801d36:	c7 04 24 4f 2a 80 00 	movl   $0x802a4f,(%esp)
  801d3d:	e8 21 e4 ff ff       	call   800163 <cprintf>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801ff0:	c7 44 24 04 67 2a 80 	movl   $0x802a67,0x4(%esp)
  801ff7:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8021b2:	c7 04 24 74 2a 80 00 	movl   $0x802a74,(%esp)
  8021b9:	e8 a5 df ff ff       	call   800163 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8021be:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8021c2:	8b 45 10             	mov    0x10(%ebp),%eax
  8021c5:	89 04 24             	mov    %eax,(%esp)
  8021c8:	e8 35 df ff ff       	call   800102 <vcprintf>
	cprintf("\n");
  8021cd:	c7 04 24 60 2a 80 00 	movl   $0x802a60,(%esp)
  8021d4:	e8 8a df ff ff       	call   800163 <cprintf>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  80229a:	c7 44 24 08 98 2a 80 	movl   $0x802a98,0x8(%esp)
  8022a1:	00 
  8022a2:	c7 44 24 04 41 00 00 	movl   $0x41,0x4(%esp)
  8022a9:	00 
  8022aa:	c7 04 24 c8 2a 80 00 	movl   $0x802ac8,(%esp)
