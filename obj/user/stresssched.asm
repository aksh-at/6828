...
umain(int argc, char **argv)
{
  ...
  80004f:	bb 00 00 00 00       	mov    $0x0,%ebx
		if (fork() == 0)
  800054:	e8 5f 0f 00 00       	call   800fb8 <fork>
  ...
  8000cf:	c7 44 24 08 80 14 80 	movl   $0x801480,0x8(%esp)
  8000d6:	00 
  8000d7:	c7 44 24 04 21 00 00 	movl   $0x21,0x4(%esp)
  8000de:	00 
  8000df:	c7 04 24 a8 14 80 00 	movl   $0x8014a8,(%esp)
  ...
  8000fe:	c7 04 24 bb 14 80 00 	movl   $0x8014bb,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800199:	c7 04 24 e4 14 80 00 	movl   $0x8014e4,(%esp)
  ...
  8001af:	e8 51 00 00 00       	call   800205 <vcprintf>
	cprintf("\n");
  8001b4:	c7 04 24 d7 14 80 00 	movl   $0x8014d7,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002ef:	e8 ec 0e 00 00       	call   8011e0 <__udivdi3>
  ...
  80034f:	e8 bc 0f 00 00       	call   801310 <__umoddi3>
  800354:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800358:	0f be 80 08 15 80 00 	movsbl 0x801508(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800473:	ff 24 8d c0 15 80 00 	jmp    *0x8015c0(,%ecx,4)
  ...
  80051f:	c7 44 24 08 20 15 80 	movl   $0x801520,0x8(%esp)
  800526:	00 
  ...
  80053f:	c7 44 24 08 29 15 80 	movl   $0x801529,0x8(%esp)
  800546:	00 
  ...
  800571:	b8 19 15 80 00       	mov    $0x801519,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c40:	00 
  800c41:	c7 44 24 08 44 17 80 	movl   $0x801744,0x8(%esp)
  800c48:	00 
  800c49:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c50:	00 
  800c51:	c7 04 24 61 17 80 00 	movl   $0x801761,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800cd2:	00 
  800cd3:	c7 44 24 08 44 17 80 	movl   $0x801744,0x8(%esp)
  800cda:	00 
  800cdb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ce2:	00 
  800ce3:	c7 04 24 61 17 80 00 	movl   $0x801761,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d25:	00 
  800d26:	c7 44 24 08 44 17 80 	movl   $0x801744,0x8(%esp)
  800d2d:	00 
  800d2e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d35:	00 
  800d36:	c7 04 24 61 17 80 00 	movl   $0x801761,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d78:	00 
  800d79:	c7 44 24 08 44 17 80 	movl   $0x801744,0x8(%esp)
  800d80:	00 
  800d81:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d88:	00 
  800d89:	c7 04 24 61 17 80 00 	movl   $0x801761,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800dcb:	00 
  800dcc:	c7 44 24 08 44 17 80 	movl   $0x801744,0x8(%esp)
  800dd3:	00 
  800dd4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ddb:	00 
  800ddc:	c7 04 24 61 17 80 00 	movl   $0x801761,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e1e:	00 
  800e1f:	c7 44 24 08 44 17 80 	movl   $0x801744,0x8(%esp)
  800e26:	00 
  800e27:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e2e:	00 
  800e2f:	c7 04 24 61 17 80 00 	movl   $0x801761,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e93:	00 
  800e94:	c7 44 24 08 44 17 80 	movl   $0x801744,0x8(%esp)
  800e9b:	00 
  800e9c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ea3:	00 
  800ea4:	c7 04 24 61 17 80 00 	movl   $0x801761,(%esp)
...
pgfault(struct UTrapframe *utf)
{
  ...
  800ec3:	8b 30                	mov    (%eax),%esi
	...
	if(!(err & FEC_WR)) {
  800ec5:	f6 40 04 02          	testb  $0x2,0x4(%eax)
  800ec9:	75 1c                	jne    800ee7 <pgfault+0x2f>
		panic("Not a write");
  800ecb:	c7 44 24 08 6f 17 80 	movl   $0x80176f,0x8(%esp)
  800ed2:	00 
  800ed3:	c7 44 24 04 20 00 00 	movl   $0x20,0x4(%esp)
  800eda:	00 
  800edb:	c7 04 24 7b 17 80 00 	movl   $0x80177b,(%esp)
  800ee2:	e8 86 f2 ff ff       	call   80016d <_panic>
	}
  ...
  800ef6:	75 1c                	jne    800f14 <pgfault+0x5c>
		panic("Not a COW page");
  800ef8:	c7 44 24 08 86 17 80 	movl   $0x801786,0x8(%esp)
  800eff:	00 
  800f00:	c7 44 24 04 24 00 00 	movl   $0x24,0x4(%esp)
  800f07:	00 
  800f08:	c7 04 24 7b 17 80 00 	movl   $0x80177b,(%esp)
  800f0f:	e8 59 f2 ff ff       	call   80016d <_panic>
  ...
  800f14:	e8 4c fd ff ff       	call   800c65 <sys_getenvid>
  800f19:	89 c3                	mov    %eax,%ebx
	r = sys_page_alloc(envid, PFTEMP, PTE_W | PTE_U | PTE_P);
  800f1b:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  800f22:	00 
  800f23:	c7 44 24 04 00 f0 7f 	movl   $0x7ff000,0x4(%esp)
  800f2a:	00 
  800f2b:	89 04 24             	mov    %eax,(%esp)
  800f2e:	e8 70 fd ff ff       	call   800ca3 <sys_page_alloc>
	if(r < 0) {
  800f33:	85 c0                	test   %eax,%eax
  800f35:	79 1c                	jns    800f53 <pgfault+0x9b>
		panic("couldn't allocate page");
  800f37:	c7 44 24 08 95 17 80 	movl   $0x801795,0x8(%esp)
  800f3e:	00 
  800f3f:	c7 44 24 04 2f 00 00 	movl   $0x2f,0x4(%esp)
  800f46:	00 
  800f47:	c7 04 24 7b 17 80 00 	movl   $0x80177b,(%esp)
  800f4e:	e8 1a f2 ff ff       	call   80016d <_panic>
	}

	memmove(PFTEMP, ROUNDDOWN(addr, PGSIZE), PGSIZE);
  800f53:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  800f59:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
  800f60:	00 
  800f61:	89 74 24 04          	mov    %esi,0x4(%esp)
  800f65:	c7 04 24 00 f0 7f 00 	movl   $0x7ff000,(%esp)
  800f6c:	e8 b3 fa ff ff       	call   800a24 <memmove>

	r = sys_page_map(envid, PFTEMP, envid, ROUNDDOWN(addr,PGSIZE), PTE_P | PTE_U | PTE_W);
  800f71:	c7 44 24 10 07 00 00 	movl   $0x7,0x10(%esp)
  800f78:	00 
  800f79:	89 74 24 0c          	mov    %esi,0xc(%esp)
  800f7d:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800f81:	c7 44 24 04 00 f0 7f 	movl   $0x7ff000,0x4(%esp)
  800f88:	00 
  800f89:	89 1c 24             	mov    %ebx,(%esp)
  800f8c:	e8 66 fd ff ff       	call   800cf7 <sys_page_map>
	if(r < 0) {
  800f91:	85 c0                	test   %eax,%eax
  800f93:	79 1c                	jns    800fb1 <pgfault+0xf9>
		panic("couldn't map page");
  800f95:	c7 44 24 08 ac 17 80 	movl   $0x8017ac,0x8(%esp)
  800f9c:	00 
  800f9d:	c7 44 24 04 36 00 00 	movl   $0x36,0x4(%esp)
  800fa4:	00 
  800fa5:	c7 04 24 7b 17 80 00 	movl   $0x80177b,(%esp)
  800fac:	e8 bc f1 ff ff       	call   80016d <_panic>
	}
}
...
fork(void)
{
  ...
  800fbc:	56                   	push   %esi
  800fbd:	53                   	push   %ebx
  800fbe:	83 ec 3c             	sub    $0x3c,%esp
	envid_t envid;
	uintptr_t addr;
	int r = 0;

	set_pgfault_handler(pgfault);
  800fc1:	c7 04 24 b8 0e 80 00 	movl   $0x800eb8,(%esp)
  800fc8:	e8 9d 01 00 00       	call   80116a <set_pgfault_handler>
...
sys_exofork(void)
{
  ...
  800fd4:	89 45 d4             	mov    %eax,-0x2c(%ebp)
  800fd7:	89 45 d8             	mov    %eax,-0x28(%ebp)

	envid = sys_exofork();
	if(envid == 0) {
  800fda:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
  800fe1:	bf 00 00 00 00       	mov    $0x0,%edi
  800fe6:	85 c0                	test   %eax,%eax
  800fe8:	75 21                	jne    80100b <fork+0x53>
		thisenv = &envs[ENVX(sys_getenvid())];
  800fea:	e8 76 fc ff ff       	call   800c65 <sys_getenvid>
  ...
  801006:	e9 35 01 00 00       	jmp    801140 <fork+0x188>
	}

	for(addr = 0; addr < UTOP - PGSIZE; addr +=PGSIZE) {
		r += duppage(envid, PGNUM(addr));
  80100b:	89 fa                	mov    %edi,%edx
  80100d:	c1 ea 0c             	shr    $0xc,%edx
//
static int
duppage(envid_t envid, unsigned pn)
{
  ...
  801012:	c1 e3 0c             	shl    $0xc,%ebx
  801015:	89 d8                	mov    %ebx,%eax
  801017:	c1 e8 16             	shr    $0x16,%eax
  80101a:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
  801021:	b8 00 00 00 00       	mov    $0x0,%eax
  801026:	f6 c1 01             	test   $0x1,%cl
  801029:	0f 84 97 00 00 00    	je     8010c6 <fork+0x10e>

	int all_perms = PTE_U | PTE_P | PTE_AVAIL | PTE_W | PTE_COW;
	int orig_perms = uvpt[pn] & all_perms;
  80102f:	8b 34 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%esi
  801036:	89 f0                	mov    %esi,%eax
  801038:	25 07 0e 00 00       	and    $0xe07,%eax
  80103d:	89 45 e0             	mov    %eax,-0x20(%ebp)

	if(!(orig_perms & PTE_P)) return 0;
  801040:	89 f0                	mov    %esi,%eax
  801042:	83 e0 01             	and    $0x1,%eax
  801045:	74 7f                	je     8010c6 <fork+0x10e>

	int r = 0;
	envid_t curenvid = sys_getenvid();
  801047:	e8 19 fc ff ff       	call   800c65 <sys_getenvid>
  80104c:	89 45 dc             	mov    %eax,-0x24(%ebp)

	if(((orig_perms) & PTE_COW) || (orig_perms & PTE_W) ) {
  80104f:	f7 c6 02 08 00 00    	test   $0x802,%esi
  801055:	74 4e                	je     8010a5 <fork+0xed>
		r += sys_page_map(curenvid, (void *) (pn*PGSIZE), envid, (void *) (pn*PGSIZE), (orig_perms | PTE_COW) & (~PTE_W));
  801057:	8b 45 e0             	mov    -0x20(%ebp),%eax
  80105a:	25 fd f7 ff ff       	and    $0xfffff7fd,%eax
  80105f:	80 cc 08             	or     $0x8,%ah
  801062:	89 c6                	mov    %eax,%esi
  801064:	89 44 24 10          	mov    %eax,0x10(%esp)
  801068:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  80106c:	8b 45 d8             	mov    -0x28(%ebp),%eax
  ...
  80107d:	e8 75 fc ff ff       	call   800cf7 <sys_page_map>
  801082:	89 45 e0             	mov    %eax,-0x20(%ebp)

		r += sys_page_map(curenvid, (void *) (pn*PGSIZE), curenvid, (void *) (pn*PGSIZE), (orig_perms | PTE_COW) & (~PTE_W));
  801085:	89 74 24 10          	mov    %esi,0x10(%esp)
  801089:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  80108d:	8b 4d dc             	mov    -0x24(%ebp),%ecx
  801090:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  801094:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  801098:	89 0c 24             	mov    %ecx,(%esp)
  80109b:	e8 57 fc ff ff       	call   800cf7 <sys_page_map>
  8010a0:	03 45 e0             	add    -0x20(%ebp),%eax
  8010a3:	eb 21                	jmp    8010c6 <fork+0x10e>
	} else {
  ...
  8010ac:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  8010b0:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8010b3:	89 44 24 08          	mov    %eax,0x8(%esp)
  8010b7:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8010bb:	8b 45 dc             	mov    -0x24(%ebp),%eax
  8010be:	89 04 24             	mov    %eax,(%esp)
  8010c1:	e8 31 fc ff ff       	call   800cf7 <sys_page_map>
		thisenv = &envs[ENVX(sys_getenvid())];
		return 0;
	}
	...
	for(addr = 0; addr < UTOP - PGSIZE; addr +=PGSIZE) {
		r += duppage(envid, PGNUM(addr));
  8010c6:	01 45 e4             	add    %eax,-0x1c(%ebp)
	if(envid == 0) {
		thisenv = &envs[ENVX(sys_getenvid())];
		return 0;
	}
	...
	for(addr = 0; addr < UTOP - PGSIZE; addr +=PGSIZE) {
  8010c9:	81 c7 00 10 00 00    	add    $0x1000,%edi
  8010cf:	81 ff 00 f0 bf ee    	cmp    $0xeebff000,%edi
  8010d5:	0f 85 30 ff ff ff    	jne    80100b <fork+0x53>
		r += duppage(envid, PGNUM(addr));
	}
  ...
  8010ea:	ee 
  8010eb:	8b 75 d4             	mov    -0x2c(%ebp),%esi
  8010ee:	89 34 24             	mov    %esi,(%esp)
  8010f1:	e8 ad fb ff ff       	call   800ca3 <sys_page_alloc>
  8010f6:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
  8010f9:	01 c3                	add    %eax,%ebx
	r+=sys_env_set_pgfault_upcall(envid, _pgfault_upcall);
  8010fb:	c7 44 24 04 b7 11 80 	movl   $0x8011b7,0x4(%esp)
  801102:	00 
  801103:	89 34 24             	mov    %esi,(%esp)
  801106:	e8 e5 fc ff ff       	call   800df0 <sys_env_set_pgfault_upcall>
  80110b:	01 c3                	add    %eax,%ebx
	r+= sys_env_set_status(envid, ENV_RUNNABLE);
  80110d:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  801114:	00 
  801115:	89 34 24             	mov    %esi,(%esp)
  801118:	e8 80 fc ff ff       	call   800d9d <sys_env_set_status>

	if(r<0) {
  80111d:	01 d8                	add    %ebx,%eax
  80111f:	79 1c                	jns    80113d <fork+0x185>
	 panic("fork failed!");
  801121:	c7 44 24 08 be 17 80 	movl   $0x8017be,0x8(%esp)
  801128:	00 
  801129:	c7 44 24 04 86 00 00 	movl   $0x86,0x4(%esp)
  801130:	00 
  801131:	c7 04 24 7b 17 80 00 	movl   $0x80177b,(%esp)
...
sfork(void)
{
  ...
  80114e:	c7 44 24 08 cb 17 80 	movl   $0x8017cb,0x8(%esp)
  801155:	00 
  801156:	c7 44 24 04 90 00 00 	movl   $0x90,0x4(%esp)
  80115d:	00 
  80115e:	c7 04 24 7b 17 80 00 	movl   $0x80177b,(%esp)
  801165:	e8 03 f0 ff ff       	call   80016d <_panic>

0080116a <set_pgfault_handler>:
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801171:	83 3d 0c 20 80 00 00 	cmpl   $0x0,0x80200c
  801178:	75 2f                	jne    8011a9 <set_pgfault_handler+0x3f>
		// First time through!
		// LAB 4: Your code here.
		envid_t envid = sys_getenvid();
  80117a:	e8 e6 fa ff ff       	call   800c65 <sys_getenvid>
  ...
  801188:	00 
  801189:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  801190:	ee 
  801191:	89 04 24             	mov    %eax,(%esp)
  801194:	e8 0a fb ff ff       	call   800ca3 <sys_page_alloc>
		sys_env_set_pgfault_upcall(envid, (void *)_pgfault_upcall);
  801199:	c7 44 24 04 b7 11 80 	movl   $0x8011b7,0x4(%esp)
  8011a0:	00 
  8011a1:	89 1c 24             	mov    %ebx,(%esp)
  8011a4:	e8 47 fc ff ff       	call   800df0 <sys_env_set_pgfault_upcall>
	}

	// Save handler pointer for assembly to call.
	_pgfault_handler = handler;
  8011a9:	8b 45 08             	mov    0x8(%ebp),%eax
  8011ac:	a3 0c 20 80 00       	mov    %eax,0x80200c
}
...
_pgfault_upcall:
  ...
  8011bf:	83 c4 04             	add    $0x4,%esp
	...
	subl $4, 0x30(%esp)
  8011c2:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
	movl 0x30(%esp), %eax 
  8011c7:	8b 44 24 30          	mov    0x30(%esp),%eax
	movl 0x28(%esp), %ebp
  8011cb:	8b 6c 24 28          	mov    0x28(%esp),%ebp
	movl %ebp, (%eax)
  8011cf:	89 28                	mov    %ebp,(%eax)
