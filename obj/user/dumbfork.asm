...
sys_env_destroy(envid_t envid)
{
  ...
  800d80:	00 
  800d81:	c7 44 24 08 a4 15 80 	movl   $0x8015a4,0x8(%esp)
  800d88:	00 
  800d89:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d90:	00 
  800d91:	c7 04 24 c1 15 80 00 	movl   $0x8015c1,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800e12:	00 
  800e13:	c7 44 24 08 a4 15 80 	movl   $0x8015a4,0x8(%esp)
  800e1a:	00 
  800e1b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e22:	00 
  800e23:	c7 04 24 c1 15 80 00 	movl   $0x8015c1,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800e65:	00 
  800e66:	c7 44 24 08 a4 15 80 	movl   $0x8015a4,0x8(%esp)
  800e6d:	00 
  800e6e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e75:	00 
  800e76:	c7 04 24 c1 15 80 00 	movl   $0x8015c1,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800eb8:	00 
  800eb9:	c7 44 24 08 a4 15 80 	movl   $0x8015a4,0x8(%esp)
  800ec0:	00 
  800ec1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ec8:	00 
  800ec9:	c7 04 24 c1 15 80 00 	movl   $0x8015c1,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800f0b:	00 
  800f0c:	c7 44 24 08 a4 15 80 	movl   $0x8015a4,0x8(%esp)
  800f13:	00 
  800f14:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f1b:	00 
  800f1c:	c7 04 24 c1 15 80 00 	movl   $0x8015c1,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800f5e:	00 
  800f5f:	c7 44 24 08 a4 15 80 	movl   $0x8015a4,0x8(%esp)
  800f66:	00 
  800f67:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f6e:	00 
  800f6f:	c7 04 24 c1 15 80 00 	movl   $0x8015c1,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800fd3:	00 
  800fd4:	c7 44 24 08 a4 15 80 	movl   $0x8015a4,0x8(%esp)
  800fdb:	00 
  800fdc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800fe3:	00 
  800fe4:	c7 04 24 c1 15 80 00 	movl   $0x8015c1,(%esp)
