...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800168:	c7 04 24 18 12 80 00 	movl   $0x801218,(%esp)
  ...
  80017e:	e8 51 00 00 00       	call   8001d4 <vcprintf>
	cprintf("\n");
  800183:	c7 04 24 a8 11 80 00 	movl   $0x8011a8,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002bf:	e8 3c 0c 00 00       	call   800f00 <__udivdi3>
  ...
  80031f:	e8 0c 0d 00 00       	call   801030 <__umoddi3>
  800324:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800328:	0f be 80 3c 12 80 00 	movsbl 0x80123c(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800443:	ff 24 8d 00 13 80 00 	jmp    *0x801300(,%ecx,4)
  ...
  80050f:	c7 44 24 08 5d 12 80 	movl   $0x80125d,0x8(%esp)
  800516:	00 
  ...
  800541:	b8 4d 12 80 00       	mov    $0x80124d,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c10:	00 
  800c11:	c7 44 24 08 84 14 80 	movl   $0x801484,0x8(%esp)
  800c18:	00 
  800c19:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c20:	00 
  800c21:	c7 04 24 a1 14 80 00 	movl   $0x8014a1,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800ca2:	00 
  800ca3:	c7 44 24 08 84 14 80 	movl   $0x801484,0x8(%esp)
  800caa:	00 
  800cab:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cb2:	00 
  800cb3:	c7 04 24 a1 14 80 00 	movl   $0x8014a1,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cf5:	00 
  800cf6:	c7 44 24 08 84 14 80 	movl   $0x801484,0x8(%esp)
  800cfd:	00 
  800cfe:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d05:	00 
  800d06:	c7 04 24 a1 14 80 00 	movl   $0x8014a1,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d48:	00 
  800d49:	c7 44 24 08 84 14 80 	movl   $0x801484,0x8(%esp)
  800d50:	00 
  800d51:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d58:	00 
  800d59:	c7 04 24 a1 14 80 00 	movl   $0x8014a1,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d9b:	00 
  800d9c:	c7 44 24 08 84 14 80 	movl   $0x801484,0x8(%esp)
  800da3:	00 
  800da4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dab:	00 
  800dac:	c7 04 24 a1 14 80 00 	movl   $0x8014a1,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dee:	00 
  800def:	c7 44 24 08 84 14 80 	movl   $0x801484,0x8(%esp)
  800df6:	00 
  800df7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dfe:	00 
  800dff:	c7 04 24 a1 14 80 00 	movl   $0x8014a1,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e63:	00 
  800e64:	c7 44 24 08 84 14 80 	movl   $0x801484,0x8(%esp)
  800e6b:	00 
  800e6c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e73:	00 
  800e74:	c7 04 24 a1 14 80 00 	movl   $0x8014a1,(%esp)
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800e8b:	53                   	push   %ebx
  800e8c:	83 ec 14             	sub    $0x14,%esp
	int r;

	if (_pgfault_handler == 0) {
  800e8f:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  800e96:	75 2f                	jne    800ec7 <set_pgfault_handler+0x3f>
		// First time through!
		// LAB 4: Your code here.
		envid_t envid = sys_getenvid();
  800e98:	e8 98 fd ff ff       	call   800c35 <sys_getenvid>
  ...
  800ea6:	00 
  800ea7:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  800eae:	ee 
  800eaf:	89 04 24             	mov    %eax,(%esp)
  800eb2:	e8 bc fd ff ff       	call   800c73 <sys_page_alloc>
		sys_env_set_pgfault_upcall(envid, (void *)_pgfault_upcall);
  800eb7:	c7 44 24 04 d5 0e 80 	movl   $0x800ed5,0x4(%esp)
  800ebe:	00 
  800ebf:	89 1c 24             	mov    %ebx,(%esp)
  800ec2:	e8 f9 fe ff ff       	call   800dc0 <sys_env_set_pgfault_upcall>
	}
...
_pgfault_upcall:
  ...
  800ed6:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  800edd:	83 c4 04             	add    $0x4,%esp
	...
	subl $4, 0x30(%esp)
  800ee0:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
	movl 0x30(%esp), %eax 
  800ee5:	8b 44 24 30          	mov    0x30(%esp),%eax
	movl 0x28(%esp), %ebp
  800ee9:	8b 6c 24 28          	mov    0x28(%esp),%ebp
	movl %ebp, (%eax)
  800eed:	89 28                	mov    %ebp,(%eax)
