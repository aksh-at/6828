...
umain(int argc, char **argv)
{
  ...
  800039:	83 ec 3c             	sub    $0x3c,%esp
	...
	i = 0;
	if ((who = sfork()) != 0) {
  80003c:	e8 e7 10 00 00       	call   801128 <sfork>
  ...
  800077:	c7 04 24 3a 15 80 00 	movl   $0x80153a,(%esp)
  ...
  8000a1:	e8 c6 10 00 00       	call   80116c <ipc_send>
	}
  ...
  8000bc:	e8 89 10 00 00       	call   80114a <ipc_recv>
  ...
  8000f1:	c7 04 24 50 15 80 00 	movl   $0x801550,(%esp)
  ...
  80012d:	e8 3a 10 00 00       	call   80116c <ipc_send>
		if (val == 10)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002cf:	e8 bc 0f 00 00       	call   801290 <__udivdi3>
  ...
  80032f:	e8 8c 10 00 00       	call   8013c0 <__umoddi3>
  800334:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800338:	0f be 80 80 15 80 00 	movsbl 0x801580(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800453:	ff 24 8d 40 16 80 00 	jmp    *0x801640(,%ecx,4)
  ...
  80051f:	c7 44 24 08 a1 15 80 	movl   $0x8015a1,0x8(%esp)
  800526:	00 
  ...
  800551:	b8 91 15 80 00       	mov    $0x801591,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c20:	00 
  800c21:	c7 44 24 08 c4 17 80 	movl   $0x8017c4,0x8(%esp)
  800c28:	00 
  800c29:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c30:	00 
  800c31:	c7 04 24 e1 17 80 00 	movl   $0x8017e1,(%esp)
  800c38:	e8 89 05 00 00       	call   8011c6 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800cb2:	00 
  800cb3:	c7 44 24 08 c4 17 80 	movl   $0x8017c4,0x8(%esp)
  800cba:	00 
  800cbb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cc2:	00 
  800cc3:	c7 04 24 e1 17 80 00 	movl   $0x8017e1,(%esp)
  800cca:	e8 f7 04 00 00       	call   8011c6 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d05:	00 
  800d06:	c7 44 24 08 c4 17 80 	movl   $0x8017c4,0x8(%esp)
  800d0d:	00 
  800d0e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d15:	00 
  800d16:	c7 04 24 e1 17 80 00 	movl   $0x8017e1,(%esp)
  800d1d:	e8 a4 04 00 00       	call   8011c6 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d58:	00 
  800d59:	c7 44 24 08 c4 17 80 	movl   $0x8017c4,0x8(%esp)
  800d60:	00 
  800d61:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d68:	00 
  800d69:	c7 04 24 e1 17 80 00 	movl   $0x8017e1,(%esp)
  800d70:	e8 51 04 00 00       	call   8011c6 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800dab:	00 
  800dac:	c7 44 24 08 c4 17 80 	movl   $0x8017c4,0x8(%esp)
  800db3:	00 
  800db4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dbb:	00 
  800dbc:	c7 04 24 e1 17 80 00 	movl   $0x8017e1,(%esp)
  800dc3:	e8 fe 03 00 00       	call   8011c6 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dfe:	00 
  800dff:	c7 44 24 08 c4 17 80 	movl   $0x8017c4,0x8(%esp)
  800e06:	00 
  800e07:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e0e:	00 
  800e0f:	c7 04 24 e1 17 80 00 	movl   $0x8017e1,(%esp)
  800e16:	e8 ab 03 00 00       	call   8011c6 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800e73:	00 
  800e74:	c7 44 24 08 c4 17 80 	movl   $0x8017c4,0x8(%esp)
  800e7b:	00 
  800e7c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e83:	00 
  800e84:	c7 04 24 e1 17 80 00 	movl   $0x8017e1,(%esp)
  800e8b:	e8 36 03 00 00       	call   8011c6 <_panic>
...
pgfault(struct UTrapframe *utf)
{
  ...
  800ea9:	75 1c                	jne    800ec7 <pgfault+0x2f>
		panic("Not a write");
  800eab:	c7 44 24 08 ef 17 80 	movl   $0x8017ef,0x8(%esp)
  800eb2:	00 
  800eb3:	c7 44 24 04 20 00 00 	movl   $0x20,0x4(%esp)
  800eba:	00 
  800ebb:	c7 04 24 fb 17 80 00 	movl   $0x8017fb,(%esp)
  800ec2:	e8 ff 02 00 00       	call   8011c6 <_panic>
	}
  ...
  800ed8:	c7 44 24 08 06 18 80 	movl   $0x801806,0x8(%esp)
  800edf:	00 
  800ee0:	c7 44 24 04 24 00 00 	movl   $0x24,0x4(%esp)
  800ee7:	00 
  800ee8:	c7 04 24 fb 17 80 00 	movl   $0x8017fb,(%esp)
  800eef:	e8 d2 02 00 00       	call   8011c6 <_panic>
  ...
  800f15:	79 1c                	jns    800f33 <pgfault+0x9b>
		panic("couldn't allocate page");
  800f17:	c7 44 24 08 15 18 80 	movl   $0x801815,0x8(%esp)
  800f1e:	00 
  800f1f:	c7 44 24 04 2f 00 00 	movl   $0x2f,0x4(%esp)
  800f26:	00 
  800f27:	c7 04 24 fb 17 80 00 	movl   $0x8017fb,(%esp)
  800f2e:	e8 93 02 00 00       	call   8011c6 <_panic>
	}

	memmove(PFTEMP, ROUNDDOWN(addr, PGSIZE), PGSIZE);
  800f33:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  800f39:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
  800f40:	00 
  800f41:	89 74 24 04          	mov    %esi,0x4(%esp)
  800f45:	c7 04 24 00 f0 7f 00 	movl   $0x7ff000,(%esp)
  800f4c:	e8 b3 fa ff ff       	call   800a04 <memmove>

	r = sys_page_map(envid, PFTEMP, envid, ROUNDDOWN(addr,PGSIZE), PTE_P | PTE_U | PTE_W);
  800f51:	c7 44 24 10 07 00 00 	movl   $0x7,0x10(%esp)
  800f58:	00 
  800f59:	89 74 24 0c          	mov    %esi,0xc(%esp)
  800f5d:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800f61:	c7 44 24 04 00 f0 7f 	movl   $0x7ff000,0x4(%esp)
  800f68:	00 
  800f69:	89 1c 24             	mov    %ebx,(%esp)
  800f6c:	e8 66 fd ff ff       	call   800cd7 <sys_page_map>
	if(r < 0) {
  800f71:	85 c0                	test   %eax,%eax
  800f73:	79 1c                	jns    800f91 <pgfault+0xf9>
		panic("couldn't map page");
  800f75:	c7 44 24 08 2c 18 80 	movl   $0x80182c,0x8(%esp)
  800f7c:	00 
  800f7d:	c7 44 24 04 36 00 00 	movl   $0x36,0x4(%esp)
  800f84:	00 
  800f85:	c7 04 24 fb 17 80 00 	movl   $0x8017fb,(%esp)
  800f8c:	e8 35 02 00 00       	call   8011c6 <_panic>
	}
}
...
fork(void)
{
  ...
  800f9c:	56                   	push   %esi
  800f9d:	53                   	push   %ebx
  800f9e:	83 ec 3c             	sub    $0x3c,%esp
	envid_t envid;
	uintptr_t addr;
	int r = 0;

	set_pgfault_handler(pgfault);
  800fa1:	c7 04 24 98 0e 80 00 	movl   $0x800e98,(%esp)
  800fa8:	e8 6f 02 00 00       	call   80121c <set_pgfault_handler>
...
sys_exofork(void)
{
	envid_t ret;
	asm volatile("int %2"
  800fad:	b8 07 00 00 00       	mov    $0x7,%eax
  800fb2:	cd 30                	int    $0x30
  800fb4:	89 45 d4             	mov    %eax,-0x2c(%ebp)
  800fb7:	89 45 d8             	mov    %eax,-0x28(%ebp)

	envid = sys_exofork();
	if(envid == 0) {
  800fba:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
  800fc1:	bf 00 00 00 00       	mov    $0x0,%edi
  800fc6:	85 c0                	test   %eax,%eax
  800fc8:	75 21                	jne    800feb <fork+0x53>
		thisenv = &envs[ENVX(sys_getenvid())];
  800fca:	e8 76 fc ff ff       	call   800c45 <sys_getenvid>
  800fcf:	25 ff 03 00 00       	and    $0x3ff,%eax
  800fd4:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800fd7:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  800fdc:	a3 08 20 80 00       	mov    %eax,0x802008
		return 0;
  800fe1:	b8 00 00 00 00       	mov    $0x0,%eax
  800fe6:	e9 35 01 00 00       	jmp    801120 <fork+0x188>
	}
...
duppage(envid_t envid, unsigned pn)
{
  ...
  800ffa:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
  801001:	b8 00 00 00 00       	mov    $0x0,%eax
  801006:	f6 c1 01             	test   $0x1,%cl
  801009:	0f 84 97 00 00 00    	je     8010a6 <fork+0x10e>

	int all_perms = PTE_U | PTE_P | PTE_AVAIL | PTE_W | PTE_COW;
	int orig_perms = uvpt[pn] & all_perms;
  80100f:	8b 34 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%esi
  ...
  801025:	74 7f                	je     8010a6 <fork+0x10e>

	int r = 0;
	envid_t curenvid = sys_getenvid();
  801027:	e8 19 fc ff ff       	call   800c45 <sys_getenvid>
  80102c:	89 45 dc             	mov    %eax,-0x24(%ebp)

	if(((orig_perms) & PTE_COW) || (orig_perms & PTE_W) ) {
  80102f:	f7 c6 02 08 00 00    	test   $0x802,%esi
  801035:	74 4e                	je     801085 <fork+0xed>
		r += sys_page_map(curenvid, (void *) (pn*PGSIZE), envid, (void *) (pn*PGSIZE), (orig_perms | PTE_COW) & (~PTE_W));
  801037:	8b 45 e0             	mov    -0x20(%ebp),%eax
  80103a:	25 fd f7 ff ff       	and    $0xfffff7fd,%eax
  80103f:	80 cc 08             	or     $0x8,%ah
  801042:	89 c6                	mov    %eax,%esi
  801044:	89 44 24 10          	mov    %eax,0x10(%esp)
  801048:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  80104c:	8b 45 d8             	mov    -0x28(%ebp),%eax
  80104f:	89 44 24 08          	mov    %eax,0x8(%esp)
  801053:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  801057:	8b 45 dc             	mov    -0x24(%ebp),%eax
  80105a:	89 04 24             	mov    %eax,(%esp)
  80105d:	e8 75 fc ff ff       	call   800cd7 <sys_page_map>
  801062:	89 45 e0             	mov    %eax,-0x20(%ebp)

		r += sys_page_map(curenvid, (void *) (pn*PGSIZE), curenvid, (void *) (pn*PGSIZE), (orig_perms | PTE_COW) & (~PTE_W));
  801065:	89 74 24 10          	mov    %esi,0x10(%esp)
  801069:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  80106d:	8b 4d dc             	mov    -0x24(%ebp),%ecx
  801070:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  801074:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  801078:	89 0c 24             	mov    %ecx,(%esp)
  80107b:	e8 57 fc ff ff       	call   800cd7 <sys_page_map>
  801080:	03 45 e0             	add    -0x20(%ebp),%eax
  801083:	eb 21                	jmp    8010a6 <fork+0x10e>
	} else {
  ...
  801090:	8b 45 d8             	mov    -0x28(%ebp),%eax
  801093:	89 44 24 08          	mov    %eax,0x8(%esp)
  801097:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  80109b:	8b 45 dc             	mov    -0x24(%ebp),%eax
  80109e:	89 04 24             	mov    %eax,(%esp)
  8010a1:	e8 31 fc ff ff       	call   800cd7 <sys_page_map>
		thisenv = &envs[ENVX(sys_getenvid())];
		return 0;
	}
	...
	for(addr = 0; addr < UTOP - PGSIZE; addr +=PGSIZE) {
		r += duppage(envid, PGNUM(addr));
  8010a6:	01 45 e4             	add    %eax,-0x1c(%ebp)
	if(envid == 0) {
		thisenv = &envs[ENVX(sys_getenvid())];
		return 0;
	}
	...
	for(addr = 0; addr < UTOP - PGSIZE; addr +=PGSIZE) {
  8010a9:	81 c7 00 10 00 00    	add    $0x1000,%edi
  8010af:	81 ff 00 f0 bf ee    	cmp    $0xeebff000,%edi
  8010b5:	0f 85 30 ff ff ff    	jne    800feb <fork+0x53>
		r += duppage(envid, PGNUM(addr));
	}
  ...
  8010c2:	00 
  8010c3:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  8010ca:	ee 
  8010cb:	8b 75 d4             	mov    -0x2c(%ebp),%esi
  8010ce:	89 34 24             	mov    %esi,(%esp)
  8010d1:	e8 ad fb ff ff       	call   800c83 <sys_page_alloc>
  8010d6:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
  8010d9:	01 c3                	add    %eax,%ebx
	r+=sys_env_set_pgfault_upcall(envid, _pgfault_upcall);
  8010db:	c7 44 24 04 69 12 80 	movl   $0x801269,0x4(%esp)
  8010e2:	00 
  8010e3:	89 34 24             	mov    %esi,(%esp)
  8010e6:	e8 e5 fc ff ff       	call   800dd0 <sys_env_set_pgfault_upcall>
  8010eb:	01 c3                	add    %eax,%ebx
	r+= sys_env_set_status(envid, ENV_RUNNABLE);
  8010ed:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  8010f4:	00 
  8010f5:	89 34 24             	mov    %esi,(%esp)
  8010f8:	e8 80 fc ff ff       	call   800d7d <sys_env_set_status>

	if(r<0) {
  8010fd:	01 d8                	add    %ebx,%eax
  8010ff:	79 1c                	jns    80111d <fork+0x185>
	 panic("fork failed!");
  801101:	c7 44 24 08 3e 18 80 	movl   $0x80183e,0x8(%esp)
  801108:	00 
  801109:	c7 44 24 04 86 00 00 	movl   $0x86,0x4(%esp)
  801110:	00 
  801111:	c7 04 24 fb 17 80 00 	movl   $0x8017fb,(%esp)
  801118:	e8 a9 00 00 00       	call   8011c6 <_panic>
	}

	return envid;
  80111d:	8b 45 d4             	mov    -0x2c(%ebp),%eax
}
  801120:	83 c4 3c             	add    $0x3c,%esp
  801123:	5b                   	pop    %ebx
  801124:	5e                   	pop    %esi
  801125:	5f                   	pop    %edi
  801126:	5d                   	pop    %ebp
...
sfork(void)
{
  ...
  80112e:	c7 44 24 08 4b 18 80 	movl   $0x80184b,0x8(%esp)
  801135:	00 
  801136:	c7 44 24 04 90 00 00 	movl   $0x90,0x4(%esp)
  80113d:	00 
  80113e:	c7 04 24 fb 17 80 00 	movl   $0x8017fb,(%esp)
  801145:	e8 7c 00 00 00       	call   8011c6 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801150:	c7 44 24 08 61 18 80 	movl   $0x801861,0x8(%esp)
  801157:	00 
  801158:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  80115f:	00 
  801160:	c7 04 24 7a 18 80 00 	movl   $0x80187a,(%esp)
  801167:	e8 5a 00 00 00       	call   8011c6 <_panic>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801172:	c7 44 24 08 84 18 80 	movl   $0x801884,0x8(%esp)
  801179:	00 
  80117a:	c7 44 24 04 2a 00 00 	movl   $0x2a,0x4(%esp)
  801181:	00 
  801182:	c7 04 24 7a 18 80 00 	movl   $0x80187a,(%esp)
  801189:	e8 38 00 00 00       	call   8011c6 <_panic>

0080118e <ipc_find_env>:
...
ipc_find_env(enum EnvType type)
{
  ...
  801199:	6b d0 7c             	imul   $0x7c,%eax,%edx
  80119c:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  8011a2:	8b 52 50             	mov    0x50(%edx),%edx
  8011a5:	39 ca                	cmp    %ecx,%edx
  8011a7:	75 0d                	jne    8011b6 <ipc_find_env+0x28>
			return envs[i].env_id;
  8011a9:	6b c0 7c             	imul   $0x7c,%eax,%eax
  8011ac:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  8011b1:	8b 40 40             	mov    0x40(%eax),%eax
  8011b4:	eb 0e                	jmp    8011c4 <ipc_find_env+0x36>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
	int i;
	for (i = 0; i < NENV; i++)
  8011b6:	83 c0 01             	add    $0x1,%eax
  8011b9:	3d 00 04 00 00       	cmp    $0x400,%eax
  8011be:	75 d9                	jne    801199 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  8011c0:	66 b8 00 00          	mov    $0x0,%ax
}
  8011c4:	5d                   	pop    %ebp
  8011c5:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8011d1:	8b 35 00 20 80 00    	mov    0x802000,%esi
  8011d7:	e8 69 fa ff ff       	call   800c45 <sys_getenvid>
  ...
  8011f2:	c7 04 24 a0 18 80 00 	movl   $0x8018a0,(%esp)
  8011f9:	e8 48 f0 ff ff       	call   800246 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8011fe:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  801202:	8b 45 10             	mov    0x10(%ebp),%eax
  801205:	89 04 24             	mov    %eax,(%esp)
  801208:	e8 d8 ef ff ff       	call   8001e5 <vcprintf>
	cprintf("\n");
  80120d:	c7 04 24 38 15 80 00 	movl   $0x801538,(%esp)
  801214:	e8 2d f0 ff ff       	call   800246 <cprintf>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801223:	83 3d 0c 20 80 00 00 	cmpl   $0x0,0x80200c
  80122a:	75 2f                	jne    80125b <set_pgfault_handler+0x3f>
		// First time through!
		// LAB 4: Your code here.
		envid_t envid = sys_getenvid();
  80122c:	e8 14 fa ff ff       	call   800c45 <sys_getenvid>
  ...
  80123a:	00 
  80123b:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  801242:	ee 
  801243:	89 04 24             	mov    %eax,(%esp)
  801246:	e8 38 fa ff ff       	call   800c83 <sys_page_alloc>
		sys_env_set_pgfault_upcall(envid, (void *)_pgfault_upcall);
  80124b:	c7 44 24 04 69 12 80 	movl   $0x801269,0x4(%esp)
  801252:	00 
  801253:	89 1c 24             	mov    %ebx,(%esp)
  801256:	e8 75 fb ff ff       	call   800dd0 <sys_env_set_pgfault_upcall>
	}

	// Save handler pointer for assembly to call.
	_pgfault_handler = handler;
  80125b:	8b 45 08             	mov    0x8(%ebp),%eax
  80125e:	a3 0c 20 80 00       	mov    %eax,0x80200c
}
  801263:	83 c4 14             	add    $0x14,%esp
  801266:	5b                   	pop    %ebx
  801267:	5d                   	pop    %ebp
  801268:	c3                   	ret    

00801269 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  80126a:	a1 0c 20 80 00       	mov    0x80200c,%eax
	call *%eax
  ...
  801271:	83 c4 04             	add    $0x4,%esp
	...
	subl $4, 0x30(%esp)
  801274:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
	movl 0x30(%esp), %eax 
  801279:	8b 44 24 30          	mov    0x30(%esp),%eax
	movl 0x28(%esp), %ebp
  80127d:	8b 6c 24 28          	mov    0x28(%esp),%ebp
	movl %ebp, (%eax)
  801281:	89 28                	mov    %ebp,(%eax)
