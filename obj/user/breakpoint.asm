...
exit(void)
{
  ...
  800084:	83 ec 18             	sub    $0x18,%esp
	close_all();
  800087:	e8 ee 05 00 00       	call   80067a <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  800104:	00 
  800105:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  80010c:	00 
  80010d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800114:	00 
  800115:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  80011c:	e8 35 16 00 00       	call   801756 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800196:	00 
  800197:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  80019e:	00 
  80019f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001a6:	00 
  8001a7:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  8001ae:	e8 a3 15 00 00       	call   801756 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001e9:	00 
  8001ea:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  8001f1:	00 
  8001f2:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001f9:	00 
  8001fa:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  800201:	e8 50 15 00 00       	call   801756 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80023c:	00 
  80023d:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  800244:	00 
  800245:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80024c:	00 
  80024d:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  800254:	e8 fd 14 00 00       	call   801756 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80028f:	00 
  800290:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  800297:	00 
  800298:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80029f:	00 
  8002a0:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  8002a7:	e8 aa 14 00 00       	call   801756 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002e2:	00 
  8002e3:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  8002ea:	00 
  8002eb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002f2:	00 
  8002f3:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  8002fa:	e8 57 14 00 00       	call   801756 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800335:	00 
  800336:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  80033d:	00 
  80033e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800345:	00 
  800346:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  80034d:	e8 04 14 00 00       	call   801756 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003aa:	00 
  8003ab:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  8003b2:	00 
  8003b3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003ba:	00 
  8003bb:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  8003c2:	e8 8f 13 00 00       	call   801756 <_panic>
...
sys_time_msec(void)
{
  ...
  8003da:	b8 0e 00 00 00       	mov    $0xe,%eax
...
sys_try_send_packet(void* packetva, int size)
{
  ...
  80040f:	7e 28                	jle    800439 <sys_try_send_packet+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800411:	89 44 24 10          	mov    %eax,0x10(%esp)
  800415:	c7 44 24 0c 0f 00 00 	movl   $0xf,0xc(%esp)
  80041c:	00 
  80041d:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  800424:	00 
  800425:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80042c:	00 
  80042d:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  800434:	e8 1d 13 00 00       	call   801756 <_panic>
...
sys_try_recv_packet(void** packet_dst, int* size_store)
{
  ...
  80044f:	b8 10 00 00 00       	mov    $0x10,%eax
  ...
  800462:	7e 28                	jle    80048c <sys_try_recv_packet+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800464:	89 44 24 10          	mov    %eax,0x10(%esp)
  800468:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
  80046f:	00 
  800470:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  800477:	00 
  800478:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80047f:	00 
  800480:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  800487:	e8 ca 12 00 00       	call   801756 <_panic>
...
sys_try_recv_packet(void** packet_dst, int* size_store)
{
  ...
  80048c:	83 c4 2c             	add    $0x2c,%esp
  80048f:	5b                   	pop    %ebx
  800490:	5e                   	pop    %esi
  800491:	5f                   	pop    %edi
  800492:	5d                   	pop    %ebp
  800493:	c3                   	ret    
  800494:	66 90                	xchg   %ax,%ax
  800496:	66 90                	xchg   %ax,%ax
  800498:	66 90                	xchg   %ax,%ax
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800639:	e8 d0 fb ff ff       	call   80020e <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800737:	e8 7f fa ff ff       	call   8001bb <sys_page_map>
  ...
  800772:	e8 44 fa ff ff       	call   8001bb <sys_page_map>
...
err:
  ...
  80078b:	e8 7e fa ff ff       	call   80020e <sys_page_unmap>
	sys_page_unmap(0, nva);
  800790:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800794:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80079b:	e8 6e fa ff ff       	call   80020e <sys_page_unmap>
	return r;
...
alloc_sockfd(int sockid)
{
  ...
  800e2c:	e8 36 f3 ff ff       	call   800167 <sys_page_alloc>
...
devpipe_close(struct Fd *fd)
{
  ...
  801290:	e8 79 ef ff ff       	call   80020e <sys_page_unmap>
  ...
  8012a8:	e8 61 ef ff ff       	call   80020e <sys_page_unmap>
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801344:	75 41                	jne    801387 <devpipe_write+0x6b>
			...
			sys_yield();
  801346:	e8 fd ed ff ff       	call   800148 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8013c4:	75 31                	jne    8013f7 <devpipe_read+0x63>
			...
			sys_yield();
  8013c6:	e8 7d ed ff ff       	call   800148 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  801437:	e8 2b ed ff ff       	call   800167 <sys_page_alloc>
  ...
  801471:	e8 f1 ec ff ff       	call   800167 <sys_page_alloc>
  ...
  8014a0:	e8 c2 ec ff ff       	call   800167 <sys_page_alloc>
  ...
  8014d9:	e8 dd ec ff ff       	call   8001bb <sys_page_map>
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  80161d:	e8 78 ea ff ff       	call   80009a <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801647:	eb 2a                	jmp    801673 <devcons_read+0x3d>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801649:	e8 fa ea ff ff       	call   800148 <sys_yield>
	int c;
  ...
  801650:	e8 63 ea ff ff       	call   8000b8 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  80168f:	e8 06 ea ff ff       	call   80009a <sys_cputs>
}
  801694:	c9                   	leave  
  801695:	c3                   	ret    
...
opencons(void)
{
  ...
  801728:	e8 3a ea ff ff       	call   800167 <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801767:	e8 bd e9 ff ff       	call   800129 <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  8017d9:	e8 bc e8 ff ff       	call   80009a <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801842:	e8 53 e8 ff ff       	call   80009a <sys_cputs>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8021ee:	e8 8a e1 ff ff       	call   80037d <sys_ipc_recv>
  ...
  80220b:	eb 36                	jmp    802243 <ipc_recv+0x73>
	...
	thisenv = &envs[ENVX(sys_getenvid())];
  80220d:	e8 17 df ff ff       	call   800129 <sys_getenvid>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802278:	e8 dd e0 ff ff       	call   80035a <sys_ipc_try_send>
  ...
  8022a1:	e8 b0 f4 ff ff       	call   801756 <_panic>
		...
		sys_yield();
  8022a6:	e8 9d de ff ff       	call   800148 <sys_yield>
	}
