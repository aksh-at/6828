	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800248:	0f be 80 e8 25 80 00 	movsbl 0x8025e8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800363:	ff 24 8d 20 27 80 00 	jmp    *0x802720(,%ecx,4)
  ...
  80042f:	c7 44 24 08 b5 29 80 	movl   $0x8029b5,0x8(%esp)
  800436:	00 
  ...
  800461:	b8 f9 25 80 00       	mov    $0x8025f9,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b30:	00 
  800b31:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800b38:	00 
  800b39:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b40:	00 
  800b41:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bc2:	00 
  800bc3:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800bca:	00 
  800bcb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bd2:	00 
  800bd3:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c15:	00 
  800c16:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800c1d:	00 
  800c1e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c25:	00 
  800c26:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c68:	00 
  800c69:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800c70:	00 
  800c71:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c78:	00 
  800c79:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cbb:	00 
  800cbc:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800cc3:	00 
  800cc4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ccb:	00 
  800ccc:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d0e:	00 
  800d0f:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800d16:	00 
  800d17:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d1e:	00 
  800d1f:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d61:	00 
  800d62:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800d69:	00 
  800d6a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d71:	00 
  800d72:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800dd6:	00 
  800dd7:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800dde:	00 
  800ddf:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800de6:	00 
  800de7:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
sys_try_send_packet(void* packetva, int size)
{
  ...
  800e48:	00 
  800e49:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800e50:	00 
  800e51:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e58:	00 
  800e59:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
sys_try_recv_packet(void** packet_dst, int* size_store)
{
  ...
  800e9b:	00 
  800e9c:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800ea3:	00 
  800ea4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800eab:	00 
  800eac:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800faf:	8b 04 95 88 29 80 00 	mov    0x802988(,%edx,4),%eax
  ...
  800fca:	c7 04 24 0c 29 80 00 	movl   $0x80290c,(%esp)
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80121f:	c7 04 24 4d 29 80 00 	movl   $0x80294d,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8012f7:	c7 04 24 69 29 80 00 	movl   $0x802969,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8013b0:	c7 04 24 2c 29 80 00 	movl   $0x80292c,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801634:	c7 44 24 0c 9c 29 80 	movl   $0x80299c,0xc(%esp)
  80163b:	00 
  80163c:	c7 44 24 08 a3 29 80 	movl   $0x8029a3,0x8(%esp)
  801643:	00 
  801644:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  80164b:	00 
  80164c:	c7 04 24 b8 29 80 00 	movl   $0x8029b8,(%esp)
  801653:	e8 1e 0b 00 00       	call   802176 <_panic>
	assert(r <= PGSIZE);
  801658:	3d 00 10 00 00       	cmp    $0x1000,%eax
  80165d:	7e 24                	jle    801683 <devfile_read+0x84>
  80165f:	c7 44 24 0c c3 29 80 	movl   $0x8029c3,0xc(%esp)
  801666:	00 
  801667:	c7 44 24 08 a3 29 80 	movl   $0x8029a3,0x8(%esp)
  80166e:	00 
  80166f:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  801676:	00 
  801677:	c7 04 24 b8 29 80 00 	movl   $0x8029b8,(%esp)
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801746:	c7 44 24 04 cf 29 80 	movl   $0x8029cf,0x4(%esp)
  80174d:	00 
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801b67:	c7 44 24 0c db 29 80 	movl   $0x8029db,0xc(%esp)
  801b6e:	00 
  801b6f:	c7 44 24 08 a3 29 80 	movl   $0x8029a3,0x8(%esp)
  801b76:	00 
  801b77:	c7 44 24 04 62 00 00 	movl   $0x62,0x4(%esp)
  801b7e:	00 
  801b7f:	c7 04 24 f0 29 80 00 	movl   $0x8029f0,(%esp)
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801bc5:	c7 44 24 0c fc 29 80 	movl   $0x8029fc,0xc(%esp)
  801bcc:	00 
  801bcd:	c7 44 24 08 a3 29 80 	movl   $0x8029a3,0x8(%esp)
  801bd4:	00 
  801bd5:	c7 44 24 04 6d 00 00 	movl   $0x6d,0x4(%esp)
  801bdc:	00 
  801bdd:	c7 04 24 f0 29 80 00 	movl   $0x8029f0,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801c60:	c7 44 24 04 08 2a 80 	movl   $0x802a08,0x4(%esp)
  801c67:	00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801d26:	c7 04 24 0f 2a 80 00 	movl   $0x802a0f,(%esp)
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801fe0:	c7 44 24 04 27 2a 80 	movl   $0x802a27,0x4(%esp)
  801fe7:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8021a2:	c7 04 24 34 2a 80 00 	movl   $0x802a34,(%esp)
  ...
  8021b8:	e8 36 df ff ff       	call   8000f3 <vcprintf>
	cprintf("\n");
  8021bd:	c7 04 24 dc 25 80 00 	movl   $0x8025dc,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  80228a:	c7 44 24 08 58 2a 80 	movl   $0x802a58,0x8(%esp)
  802291:	00 
  802292:	c7 44 24 04 41 00 00 	movl   $0x41,0x4(%esp)
  802299:	00 
  80229a:	c7 04 24 88 2a 80 00 	movl   $0x802a88,(%esp)
