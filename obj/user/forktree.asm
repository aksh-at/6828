...
forktree(const char *cur)
{
  ...
  80004a:	c7 04 24 60 14 80 00 	movl   $0x801460,(%esp)
...
forkchild(const char *cur, char branch)
{
  ...
  8000a4:	c7 44 24 08 71 14 80 	movl   $0x801471,0x8(%esp)
  8000ab:	00 
  ...
  8000ba:	e8 eb 06 00 00       	call   8007aa <snprintf>
	if (fork() == 0) {
  8000bf:	e8 84 0e 00 00       	call   800f48 <fork>
...
umain(int argc, char **argv)
{
  ...
  8000e2:	83 ec 18             	sub    $0x18,%esp
	forktree("");
  8000e5:	c7 04 24 70 14 80 00 	movl   $0x801470,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80027f:	e8 4c 0f 00 00       	call   8011d0 <__udivdi3>
  ...
  8002df:	e8 1c 10 00 00       	call   801300 <__umoddi3>
  8002e4:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8002e8:	0f be 80 80 14 80 00 	movsbl 0x801480(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800403:	ff 24 8d 40 15 80 00 	jmp    *0x801540(,%ecx,4)
  ...
  8004cf:	c7 44 24 08 a1 14 80 	movl   $0x8014a1,0x8(%esp)
  8004d6:	00 
  ...
  800501:	b8 91 14 80 00       	mov    $0x801491,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800bd0:	00 
  800bd1:	c7 44 24 08 c4 16 80 	movl   $0x8016c4,0x8(%esp)
  800bd8:	00 
  800bd9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800be0:	00 
  800be1:	c7 04 24 e1 16 80 00 	movl   $0x8016e1,(%esp)
  800be8:	e8 0d 05 00 00       	call   8010fa <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c62:	00 
  800c63:	c7 44 24 08 c4 16 80 	movl   $0x8016c4,0x8(%esp)
  800c6a:	00 
  800c6b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c72:	00 
  800c73:	c7 04 24 e1 16 80 00 	movl   $0x8016e1,(%esp)
  800c7a:	e8 7b 04 00 00       	call   8010fa <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cb5:	00 
  800cb6:	c7 44 24 08 c4 16 80 	movl   $0x8016c4,0x8(%esp)
  800cbd:	00 
  800cbe:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cc5:	00 
  800cc6:	c7 04 24 e1 16 80 00 	movl   $0x8016e1,(%esp)
  800ccd:	e8 28 04 00 00       	call   8010fa <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d08:	00 
  800d09:	c7 44 24 08 c4 16 80 	movl   $0x8016c4,0x8(%esp)
  800d10:	00 
  800d11:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d18:	00 
  800d19:	c7 04 24 e1 16 80 00 	movl   $0x8016e1,(%esp)
  800d20:	e8 d5 03 00 00       	call   8010fa <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d5b:	00 
  800d5c:	c7 44 24 08 c4 16 80 	movl   $0x8016c4,0x8(%esp)
  800d63:	00 
  800d64:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d6b:	00 
  800d6c:	c7 04 24 e1 16 80 00 	movl   $0x8016e1,(%esp)
  800d73:	e8 82 03 00 00       	call   8010fa <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dae:	00 
  800daf:	c7 44 24 08 c4 16 80 	movl   $0x8016c4,0x8(%esp)
  800db6:	00 
  800db7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dbe:	00 
  800dbf:	c7 04 24 e1 16 80 00 	movl   $0x8016e1,(%esp)
  800dc6:	e8 2f 03 00 00       	call   8010fa <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800e23:	00 
  800e24:	c7 44 24 08 c4 16 80 	movl   $0x8016c4,0x8(%esp)
  800e2b:	00 
  800e2c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e33:	00 
  800e34:	c7 04 24 e1 16 80 00 	movl   $0x8016e1,(%esp)
  800e3b:	e8 ba 02 00 00       	call   8010fa <_panic>
...
pgfault(struct UTrapframe *utf)
{
  ...
  800e59:	75 1c                	jne    800e77 <pgfault+0x2f>
		panic("Not a write");
  800e5b:	c7 44 24 08 ef 16 80 	movl   $0x8016ef,0x8(%esp)
  800e62:	00 
  800e63:	c7 44 24 04 20 00 00 	movl   $0x20,0x4(%esp)
  800e6a:	00 
  800e6b:	c7 04 24 fb 16 80 00 	movl   $0x8016fb,(%esp)
  800e72:	e8 83 02 00 00       	call   8010fa <_panic>
	}
  ...
  800e88:	c7 44 24 08 06 17 80 	movl   $0x801706,0x8(%esp)
  800e8f:	00 
  800e90:	c7 44 24 04 24 00 00 	movl   $0x24,0x4(%esp)
  800e97:	00 
  800e98:	c7 04 24 fb 16 80 00 	movl   $0x8016fb,(%esp)
  800e9f:	e8 56 02 00 00       	call   8010fa <_panic>
  ...
  800ec5:	79 1c                	jns    800ee3 <pgfault+0x9b>
		panic("couldn't allocate page");
  800ec7:	c7 44 24 08 15 17 80 	movl   $0x801715,0x8(%esp)
  800ece:	00 
  800ecf:	c7 44 24 04 2f 00 00 	movl   $0x2f,0x4(%esp)
  800ed6:	00 
  800ed7:	c7 04 24 fb 16 80 00 	movl   $0x8016fb,(%esp)
  800ede:	e8 17 02 00 00       	call   8010fa <_panic>
	}

	memmove(PFTEMP, ROUNDDOWN(addr, PGSIZE), PGSIZE);
  800ee3:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  ...
  800efc:	e8 b3 fa ff ff       	call   8009b4 <memmove>

	r = sys_page_map(envid, PFTEMP, envid, ROUNDDOWN(addr,PGSIZE), PTE_P | PTE_U | PTE_W);
  800f01:	c7 44 24 10 07 00 00 	movl   $0x7,0x10(%esp)
  800f08:	00 
  800f09:	89 74 24 0c          	mov    %esi,0xc(%esp)
  800f0d:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800f11:	c7 44 24 04 00 f0 7f 	movl   $0x7ff000,0x4(%esp)
  800f18:	00 
  800f19:	89 1c 24             	mov    %ebx,(%esp)
  800f1c:	e8 66 fd ff ff       	call   800c87 <sys_page_map>
	if(r < 0) {
  800f21:	85 c0                	test   %eax,%eax
  800f23:	79 1c                	jns    800f41 <pgfault+0xf9>
		panic("couldn't map page");
  800f25:	c7 44 24 08 2c 17 80 	movl   $0x80172c,0x8(%esp)
  800f2c:	00 
  800f2d:	c7 44 24 04 36 00 00 	movl   $0x36,0x4(%esp)
  800f34:	00 
  800f35:	c7 04 24 fb 16 80 00 	movl   $0x8016fb,(%esp)
  800f3c:	e8 b9 01 00 00       	call   8010fa <_panic>
	}
}
...
fork(void)
{
  ...
  800f4c:	56                   	push   %esi
  800f4d:	53                   	push   %ebx
  800f4e:	83 ec 3c             	sub    $0x3c,%esp
	envid_t envid;
	uintptr_t addr;
	int r = 0;

	set_pgfault_handler(pgfault);
  800f51:	c7 04 24 48 0e 80 00 	movl   $0x800e48,(%esp)
  800f58:	e8 f3 01 00 00       	call   801150 <set_pgfault_handler>
...
sys_exofork(void)
{
  ...
  800f67:	89 45 d8             	mov    %eax,-0x28(%ebp)

	envid = sys_exofork();
	if(envid == 0) {
  800f6a:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
  800f71:	bf 00 00 00 00       	mov    $0x0,%edi
  800f76:	85 c0                	test   %eax,%eax
  800f78:	75 21                	jne    800f9b <fork+0x53>
		thisenv = &envs[ENVX(sys_getenvid())];
  800f7a:	e8 76 fc ff ff       	call   800bf5 <sys_getenvid>
  800f7f:	25 ff 03 00 00       	and    $0x3ff,%eax
  800f84:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800f87:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  800f8c:	a3 04 20 80 00       	mov    %eax,0x802004
		return 0;
  800f91:	b8 00 00 00 00       	mov    $0x0,%eax
  800f96:	e9 35 01 00 00       	jmp    8010d0 <fork+0x188>
	}
...
duppage(envid_t envid, unsigned pn)
{
  ...
  800faa:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
  800fb1:	b8 00 00 00 00       	mov    $0x0,%eax
  800fb6:	f6 c1 01             	test   $0x1,%cl
  800fb9:	0f 84 97 00 00 00    	je     801056 <fork+0x10e>

	int all_perms = PTE_U | PTE_P | PTE_AVAIL | PTE_W | PTE_COW;
	int orig_perms = uvpt[pn] & all_perms;
  800fbf:	8b 34 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%esi
  ...
  800fd2:	83 e0 01             	and    $0x1,%eax
  800fd5:	74 7f                	je     801056 <fork+0x10e>

	int r = 0;
	envid_t curenvid = sys_getenvid();
  800fd7:	e8 19 fc ff ff       	call   800bf5 <sys_getenvid>
  800fdc:	89 45 dc             	mov    %eax,-0x24(%ebp)

	if(((orig_perms) & PTE_COW) || (orig_perms & PTE_W) ) {
  800fdf:	f7 c6 02 08 00 00    	test   $0x802,%esi
  800fe5:	74 4e                	je     801035 <fork+0xed>
		r += sys_page_map(curenvid, (void *) (pn*PGSIZE), envid, (void *) (pn*PGSIZE), (orig_perms | PTE_COW) & (~PTE_W));
  800fe7:	8b 45 e0             	mov    -0x20(%ebp),%eax
  800fea:	25 fd f7 ff ff       	and    $0xfffff7fd,%eax
  800fef:	80 cc 08             	or     $0x8,%ah
  800ff2:	89 c6                	mov    %eax,%esi
  800ff4:	89 44 24 10          	mov    %eax,0x10(%esp)
  800ff8:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  800ffc:	8b 45 d8             	mov    -0x28(%ebp),%eax
  800fff:	89 44 24 08          	mov    %eax,0x8(%esp)
  801003:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  801007:	8b 45 dc             	mov    -0x24(%ebp),%eax
  80100a:	89 04 24             	mov    %eax,(%esp)
  80100d:	e8 75 fc ff ff       	call   800c87 <sys_page_map>
  801012:	89 45 e0             	mov    %eax,-0x20(%ebp)

		r += sys_page_map(curenvid, (void *) (pn*PGSIZE), curenvid, (void *) (pn*PGSIZE), (orig_perms | PTE_COW) & (~PTE_W));
  801015:	89 74 24 10          	mov    %esi,0x10(%esp)
  801019:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  80101d:	8b 4d dc             	mov    -0x24(%ebp),%ecx
  801020:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  801024:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  801028:	89 0c 24             	mov    %ecx,(%esp)
  80102b:	e8 57 fc ff ff       	call   800c87 <sys_page_map>
  801030:	03 45 e0             	add    -0x20(%ebp),%eax
  801033:	eb 21                	jmp    801056 <fork+0x10e>
	} else {
  ...
  801047:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  80104b:	8b 45 dc             	mov    -0x24(%ebp),%eax
  80104e:	89 04 24             	mov    %eax,(%esp)
  801051:	e8 31 fc ff ff       	call   800c87 <sys_page_map>
		thisenv = &envs[ENVX(sys_getenvid())];
		return 0;
	}
	...
	for(addr = 0; addr < UTOP - PGSIZE; addr +=PGSIZE) {
		r += duppage(envid, PGNUM(addr));
  801056:	01 45 e4             	add    %eax,-0x1c(%ebp)
	if(envid == 0) {
		thisenv = &envs[ENVX(sys_getenvid())];
		return 0;
	}
	...
	for(addr = 0; addr < UTOP - PGSIZE; addr +=PGSIZE) {
  801059:	81 c7 00 10 00 00    	add    $0x1000,%edi
  80105f:	81 ff 00 f0 bf ee    	cmp    $0xeebff000,%edi
  801065:	0f 85 30 ff ff ff    	jne    800f9b <fork+0x53>
		r += duppage(envid, PGNUM(addr));
	}
  ...
  80107a:	ee 
  80107b:	8b 75 d4             	mov    -0x2c(%ebp),%esi
  80107e:	89 34 24             	mov    %esi,(%esp)
  801081:	e8 ad fb ff ff       	call   800c33 <sys_page_alloc>
  801086:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
  801089:	01 c3                	add    %eax,%ebx
	r+=sys_env_set_pgfault_upcall(envid, _pgfault_upcall);
  80108b:	c7 44 24 04 9d 11 80 	movl   $0x80119d,0x4(%esp)
  801092:	00 
  801093:	89 34 24             	mov    %esi,(%esp)
  801096:	e8 e5 fc ff ff       	call   800d80 <sys_env_set_pgfault_upcall>
  80109b:	01 c3                	add    %eax,%ebx
	r+= sys_env_set_status(envid, ENV_RUNNABLE);
  80109d:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  8010a4:	00 
  8010a5:	89 34 24             	mov    %esi,(%esp)
  8010a8:	e8 80 fc ff ff       	call   800d2d <sys_env_set_status>

	if(r<0) {
  8010ad:	01 d8                	add    %ebx,%eax
  8010af:	79 1c                	jns    8010cd <fork+0x185>
	 panic("fork failed!");
  8010b1:	c7 44 24 08 3e 17 80 	movl   $0x80173e,0x8(%esp)
  8010b8:	00 
  8010b9:	c7 44 24 04 86 00 00 	movl   $0x86,0x4(%esp)
  8010c0:	00 
  8010c1:	c7 04 24 fb 16 80 00 	movl   $0x8016fb,(%esp)
  8010c8:	e8 2d 00 00 00       	call   8010fa <_panic>
	}

	return envid;
  8010cd:	8b 45 d4             	mov    -0x2c(%ebp),%eax
}
  8010d0:	83 c4 3c             	add    $0x3c,%esp
  8010d3:	5b                   	pop    %ebx
  8010d4:	5e                   	pop    %esi
  8010d5:	5f                   	pop    %edi
  8010d6:	5d                   	pop    %ebp
...
sfork(void)
{
  ...
  8010db:	83 ec 18             	sub    $0x18,%esp
	panic("sfork not implemented");
  8010de:	c7 44 24 08 4b 17 80 	movl   $0x80174b,0x8(%esp)
  8010e5:	00 
  8010e6:	c7 44 24 04 90 00 00 	movl   $0x90,0x4(%esp)
  8010ed:	00 
  8010ee:	c7 04 24 fb 16 80 00 	movl   $0x8016fb,(%esp)
  8010f5:	e8 00 00 00 00       	call   8010fa <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8010fd:	56                   	push   %esi
  8010fe:	53                   	push   %ebx
  8010ff:	83 ec 20             	sub    $0x20,%esp
	va_list ap;

	va_start(ap, fmt);
  801102:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  801105:	8b 35 00 20 80 00    	mov    0x802000,%esi
  80110b:	e8 e5 fa ff ff       	call   800bf5 <sys_getenvid>
  801110:	8b 55 0c             	mov    0xc(%ebp),%edx
  801113:	89 54 24 10          	mov    %edx,0x10(%esp)
  801117:	8b 55 08             	mov    0x8(%ebp),%edx
  80111a:	89 54 24 0c          	mov    %edx,0xc(%esp)
  80111e:	89 74 24 08          	mov    %esi,0x8(%esp)
  801122:	89 44 24 04          	mov    %eax,0x4(%esp)
  801126:	c7 04 24 64 17 80 00 	movl   $0x801764,(%esp)
  80112d:	e8 c0 f0 ff ff       	call   8001f2 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  801132:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  801136:	8b 45 10             	mov    0x10(%ebp),%eax
  801139:	89 04 24             	mov    %eax,(%esp)
  80113c:	e8 50 f0 ff ff       	call   800191 <vcprintf>
	cprintf("\n");
  801141:	c7 04 24 6f 14 80 00 	movl   $0x80146f,(%esp)
  801148:	e8 a5 f0 ff ff       	call   8001f2 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  80114d:	cc                   	int3   
  80114e:	eb fd                	jmp    80114d <_panic+0x53>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801157:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  80115e:	75 2f                	jne    80118f <set_pgfault_handler+0x3f>
		// First time through!
		// LAB 4: Your code here.
		envid_t envid = sys_getenvid();
  801160:	e8 90 fa ff ff       	call   800bf5 <sys_getenvid>
  801165:	89 c3                	mov    %eax,%ebx
		sys_page_alloc(envid, (void *)(UXSTACKTOP - PGSIZE), PTE_U|PTE_W|PTE_P);
  801167:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  80116e:	00 
  80116f:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  801176:	ee 
  801177:	89 04 24             	mov    %eax,(%esp)
  80117a:	e8 b4 fa ff ff       	call   800c33 <sys_page_alloc>
		sys_env_set_pgfault_upcall(envid, (void *)_pgfault_upcall);
  80117f:	c7 44 24 04 9d 11 80 	movl   $0x80119d,0x4(%esp)
  801186:	00 
  801187:	89 1c 24             	mov    %ebx,(%esp)
  80118a:	e8 f1 fb ff ff       	call   800d80 <sys_env_set_pgfault_upcall>
	}
...
_pgfault_upcall:
  ...
  8011a5:	83 c4 04             	add    $0x4,%esp
	...
	subl $4, 0x30(%esp)
  8011a8:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
	movl 0x30(%esp), %eax 
  8011ad:	8b 44 24 30          	mov    0x30(%esp),%eax
	movl 0x28(%esp), %ebp
  8011b1:	8b 6c 24 28          	mov    0x28(%esp),%ebp
	movl %ebp, (%eax)
  8011b5:	89 28                	mov    %ebp,(%eax)
