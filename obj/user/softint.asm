...
exit(void)
{
  ...
  800085:	83 ec 18             	sub    $0x18,%esp
	close_all();
  800088:	e8 ed 05 00 00       	call   80067a <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  800105:	00 
  800106:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  80010d:	00 
  80010e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800115:	00 
  800116:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  80011d:	e8 34 16 00 00       	call   801756 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800197:	00 
  800198:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  80019f:	00 
  8001a0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001a7:	00 
  8001a8:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  8001af:	e8 a2 15 00 00       	call   801756 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001ea:	00 
  8001eb:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  8001f2:	00 
  8001f3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001fa:	00 
  8001fb:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  800202:	e8 4f 15 00 00       	call   801756 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80023d:	00 
  80023e:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  800245:	00 
  800246:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80024d:	00 
  80024e:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  800255:	e8 fc 14 00 00       	call   801756 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800290:	00 
  800291:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  800298:	00 
  800299:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002a0:	00 
  8002a1:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  8002a8:	e8 a9 14 00 00       	call   801756 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002e3:	00 
  8002e4:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  8002eb:	00 
  8002ec:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002f3:	00 
  8002f4:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  8002fb:	e8 56 14 00 00       	call   801756 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800336:	00 
  800337:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  80033e:	00 
  80033f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800346:	00 
  800347:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  80034e:	e8 03 14 00 00       	call   801756 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003ab:	00 
  8003ac:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  8003b3:	00 
  8003b4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003bb:	00 
  8003bc:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  8003c3:	e8 8e 13 00 00       	call   801756 <_panic>
...
sys_time_msec(void)
{
  ...
  8003db:	b8 0e 00 00 00       	mov    $0xe,%eax
  8003e0:	89 d1                	mov    %edx,%ecx
...
sys_try_send_packet(void* packetva, int size)
{
  ...
  800402:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  ...
  800410:	7e 28                	jle    80043a <sys_try_send_packet+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800412:	89 44 24 10          	mov    %eax,0x10(%esp)
  800416:	c7 44 24 0c 0f 00 00 	movl   $0xf,0xc(%esp)
  80041d:	00 
  80041e:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  800425:	00 
  800426:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80042d:	00 
  80042e:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  800435:	e8 1c 13 00 00       	call   801756 <_panic>
...
sys_try_recv_packet(void** packet_dst, int* size_store)
{
  ...
  800463:	7e 28                	jle    80048d <sys_try_recv_packet+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800465:	89 44 24 10          	mov    %eax,0x10(%esp)
  800469:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
  800470:	00 
  800471:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  800478:	00 
  800479:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800480:	00 
  800481:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  800488:	e8 c9 12 00 00       	call   801756 <_panic>
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800639:	e8 d1 fb ff ff       	call   80020f <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800737:	e8 80 fa ff ff       	call   8001bc <sys_page_map>
  ...
  800772:	e8 45 fa ff ff       	call   8001bc <sys_page_map>
...
err:
  ...
  80078b:	e8 7f fa ff ff       	call   80020f <sys_page_unmap>
	sys_page_unmap(0, nva);
  800790:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800794:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80079b:	e8 6f fa ff ff       	call   80020f <sys_page_unmap>
	return r;
...
alloc_sockfd(int sockid)
{
  ...
  800e2c:	e8 37 f3 ff ff       	call   800168 <sys_page_alloc>
...
devpipe_close(struct Fd *fd)
{
  ...
  801290:	e8 7a ef ff ff       	call   80020f <sys_page_unmap>
  ...
  8012a8:	e8 62 ef ff ff       	call   80020f <sys_page_unmap>
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801344:	75 41                	jne    801387 <devpipe_write+0x6b>
			...
			sys_yield();
  801346:	e8 fe ed ff ff       	call   800149 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8013c4:	75 31                	jne    8013f7 <devpipe_read+0x63>
			...
			sys_yield();
  8013c6:	e8 7e ed ff ff       	call   800149 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  801437:	e8 2c ed ff ff       	call   800168 <sys_page_alloc>
  ...
  801471:	e8 f2 ec ff ff       	call   800168 <sys_page_alloc>
  ...
  8014a0:	e8 c3 ec ff ff       	call   800168 <sys_page_alloc>
  ...
  8014d9:	e8 de ec ff ff       	call   8001bc <sys_page_map>
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  80161d:	e8 79 ea ff ff       	call   80009b <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801647:	eb 2a                	jmp    801673 <devcons_read+0x3d>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801649:	e8 fb ea ff ff       	call   800149 <sys_yield>
	int c;
  ...
  801650:	e8 64 ea ff ff       	call   8000b9 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  80168f:	e8 07 ea ff ff       	call   80009b <sys_cputs>
}
  801694:	c9                   	leave  
  801695:	c3                   	ret    
...
opencons(void)
{
  ...
  801728:	e8 3b ea ff ff       	call   800168 <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801767:	e8 be e9 ff ff       	call   80012a <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  8017d9:	e8 bd e8 ff ff       	call   80009b <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801842:	e8 54 e8 ff ff       	call   80009b <sys_cputs>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8021ee:	e8 8b e1 ff ff       	call   80037e <sys_ipc_recv>
  ...
  80220b:	eb 36                	jmp    802243 <ipc_recv+0x73>
	...
	thisenv = &envs[ENVX(sys_getenvid())];
  80220d:	e8 18 df ff ff       	call   80012a <sys_getenvid>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802278:	e8 de e0 ff ff       	call   80035b <sys_ipc_try_send>
  ...
  8022a1:	e8 b0 f4 ff ff       	call   801756 <_panic>
		...
		sys_yield();
  8022a6:	e8 9e de ff ff       	call   800149 <sys_yield>
	}
