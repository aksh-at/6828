...
umain(int argc, char **argv)
{
  ...
  800048:	e8 63 00 00 00       	call   8000b0 <sys_cputs>
}
  80004d:	c9                   	leave  
  80004e:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  80005d:	e8 dd 00 00 00       	call   80013f <sys_getenvid>
...
exit(void)
{
  ...
  80009a:	83 ec 18             	sub    $0x18,%esp
	close_all();
  80009d:	e8 e8 05 00 00       	call   80068a <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  80011a:	00 
  80011b:	c7 44 24 08 ea 25 80 	movl   $0x8025ea,0x8(%esp)
  800122:	00 
  800123:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80012a:	00 
  80012b:	c7 04 24 07 26 80 00 	movl   $0x802607,(%esp)
  800132:	e8 2f 16 00 00       	call   801766 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001ac:	00 
  8001ad:	c7 44 24 08 ea 25 80 	movl   $0x8025ea,0x8(%esp)
  8001b4:	00 
  8001b5:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001bc:	00 
  8001bd:	c7 04 24 07 26 80 00 	movl   $0x802607,(%esp)
  8001c4:	e8 9d 15 00 00       	call   801766 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001ff:	00 
  800200:	c7 44 24 08 ea 25 80 	movl   $0x8025ea,0x8(%esp)
  800207:	00 
  800208:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80020f:	00 
  800210:	c7 04 24 07 26 80 00 	movl   $0x802607,(%esp)
  800217:	e8 4a 15 00 00       	call   801766 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800252:	00 
  800253:	c7 44 24 08 ea 25 80 	movl   $0x8025ea,0x8(%esp)
  80025a:	00 
  80025b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800262:	00 
  800263:	c7 04 24 07 26 80 00 	movl   $0x802607,(%esp)
  80026a:	e8 f7 14 00 00       	call   801766 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002a5:	00 
  8002a6:	c7 44 24 08 ea 25 80 	movl   $0x8025ea,0x8(%esp)
  8002ad:	00 
  8002ae:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002b5:	00 
  8002b6:	c7 04 24 07 26 80 00 	movl   $0x802607,(%esp)
  8002bd:	e8 a4 14 00 00       	call   801766 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002f8:	00 
  8002f9:	c7 44 24 08 ea 25 80 	movl   $0x8025ea,0x8(%esp)
  800300:	00 
  800301:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800308:	00 
  800309:	c7 04 24 07 26 80 00 	movl   $0x802607,(%esp)
  800310:	e8 51 14 00 00       	call   801766 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80034b:	00 
  80034c:	c7 44 24 08 ea 25 80 	movl   $0x8025ea,0x8(%esp)
  800353:	00 
  800354:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80035b:	00 
  80035c:	c7 04 24 07 26 80 00 	movl   $0x802607,(%esp)
  800363:	e8 fe 13 00 00       	call   801766 <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  800386:	8b 5d 10             	mov    0x10(%ebp),%ebx
  800389:	8b 7d 14             	mov    0x14(%ebp),%edi
...
sys_ipc_recv(void *dstva)
{
  ...
  8003c0:	00 
  8003c1:	c7 44 24 08 ea 25 80 	movl   $0x8025ea,0x8(%esp)
  8003c8:	00 
  8003c9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003d0:	00 
  8003d1:	c7 04 24 07 26 80 00 	movl   $0x802607,(%esp)
  8003d8:	e8 89 13 00 00       	call   801766 <_panic>
...
sys_try_send_packet(void* packetva, int size)
{
  ...
  800412:	b8 0f 00 00 00       	mov    $0xf,%eax
  ...
  800425:	7e 28                	jle    80044f <sys_try_send_packet+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800427:	89 44 24 10          	mov    %eax,0x10(%esp)
  80042b:	c7 44 24 0c 0f 00 00 	movl   $0xf,0xc(%esp)
  800432:	00 
  800433:	c7 44 24 08 ea 25 80 	movl   $0x8025ea,0x8(%esp)
  80043a:	00 
  80043b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800442:	00 
  800443:	c7 04 24 07 26 80 00 	movl   $0x802607,(%esp)
  80044a:	e8 17 13 00 00       	call   801766 <_panic>
...
sys_try_recv_packet(void** packet_dst, int* size_store)
{
  ...
  800465:	b8 10 00 00 00       	mov    $0x10,%eax
  ...
  800478:	7e 28                	jle    8004a2 <sys_try_recv_packet+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80047a:	89 44 24 10          	mov    %eax,0x10(%esp)
  80047e:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
  800485:	00 
  800486:	c7 44 24 08 ea 25 80 	movl   $0x8025ea,0x8(%esp)
  80048d:	00 
  80048e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800495:	00 
  800496:	c7 04 24 07 26 80 00 	movl   $0x802607,(%esp)
  80049d:	e8 c4 12 00 00       	call   801766 <_panic>
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80059f:	8b 04 95 94 26 80 00 	mov    0x802694(,%edx,4),%eax
  ...
  8005ba:	c7 04 24 18 26 80 00 	movl   $0x802618,(%esp)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800649:	e8 d6 fb ff ff       	call   800224 <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800747:	e8 85 fa ff ff       	call   8001d1 <sys_page_map>
  ...
  800782:	e8 4a fa ff ff       	call   8001d1 <sys_page_map>
...
err:
  ...
  80079b:	e8 84 fa ff ff       	call   800224 <sys_page_unmap>
	sys_page_unmap(0, nva);
  8007a0:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8007a4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8007ab:	e8 74 fa ff ff       	call   800224 <sys_page_unmap>
	return r;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80080f:	c7 04 24 59 26 80 00 	movl   $0x802659,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8008e7:	c7 04 24 75 26 80 00 	movl   $0x802675,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8009a0:	c7 04 24 38 26 80 00 	movl   $0x802638,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800c24:	c7 44 24 0c a8 26 80 	movl   $0x8026a8,0xc(%esp)
  800c2b:	00 
  800c2c:	c7 44 24 08 af 26 80 	movl   $0x8026af,0x8(%esp)
  800c33:	00 
  800c34:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  800c3b:	00 
  800c3c:	c7 04 24 c4 26 80 00 	movl   $0x8026c4,(%esp)
  800c43:	e8 1e 0b 00 00       	call   801766 <_panic>
	assert(r <= PGSIZE);
  800c48:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800c4d:	7e 24                	jle    800c73 <devfile_read+0x84>
  800c4f:	c7 44 24 0c cf 26 80 	movl   $0x8026cf,0xc(%esp)
  800c56:	00 
  800c57:	c7 44 24 08 af 26 80 	movl   $0x8026af,0x8(%esp)
  800c5e:	00 
  800c5f:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  800c66:	00 
  800c67:	c7 04 24 c4 26 80 00 	movl   $0x8026c4,(%esp)
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800d36:	c7 44 24 04 db 26 80 	movl   $0x8026db,0x4(%esp)
  800d3d:	00 
...
alloc_sockfd(int sockid)
{
  ...
  800e3c:	e8 3c f3 ff ff       	call   80017d <sys_page_alloc>
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801157:	c7 44 24 0c e7 26 80 	movl   $0x8026e7,0xc(%esp)
  80115e:	00 
  80115f:	c7 44 24 08 af 26 80 	movl   $0x8026af,0x8(%esp)
  801166:	00 
  801167:	c7 44 24 04 62 00 00 	movl   $0x62,0x4(%esp)
  80116e:	00 
  80116f:	c7 04 24 fc 26 80 00 	movl   $0x8026fc,(%esp)
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  8011b5:	c7 44 24 0c 08 27 80 	movl   $0x802708,0xc(%esp)
  8011bc:	00 
  8011bd:	c7 44 24 08 af 26 80 	movl   $0x8026af,0x8(%esp)
  8011c4:	00 
  8011c5:	c7 44 24 04 6d 00 00 	movl   $0x6d,0x4(%esp)
  8011cc:	00 
  8011cd:	c7 04 24 fc 26 80 00 	movl   $0x8026fc,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801250:	c7 44 24 04 14 27 80 	movl   $0x802714,0x4(%esp)
  801257:	00 
...
devpipe_close(struct Fd *fd)
{
  ...
  8012a0:	e8 7f ef ff ff       	call   800224 <sys_page_unmap>
  ...
  8012b8:	e8 67 ef ff ff       	call   800224 <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801316:	c7 04 24 1b 27 80 00 	movl   $0x80271b,(%esp)
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801354:	75 41                	jne    801397 <devpipe_write+0x6b>
			...
			sys_yield();
  801356:	e8 03 ee ff ff       	call   80015e <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8013d4:	75 31                	jne    801407 <devpipe_read+0x63>
			...
			sys_yield();
  8013d6:	e8 83 ed ff ff       	call   80015e <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  801447:	e8 31 ed ff ff       	call   80017d <sys_page_alloc>
  ...
  801481:	e8 f7 ec ff ff       	call   80017d <sys_page_alloc>
  ...
  8014b0:	e8 c8 ec ff ff       	call   80017d <sys_page_alloc>
  ...
  8014e9:	e8 e3 ec ff ff       	call   8001d1 <sys_page_map>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8015d0:	c7 44 24 04 33 27 80 	movl   $0x802733,0x4(%esp)
  8015d7:	00 
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  80162d:	e8 7e ea ff ff       	call   8000b0 <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801657:	eb 2a                	jmp    801683 <devcons_read+0x3d>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801659:	e8 00 eb ff ff       	call   80015e <sys_yield>
	int c;
  ...
  801660:	e8 69 ea ff ff       	call   8000ce <sys_cgetc>
...
cputchar(int ch)
{
  ...
  80169f:	e8 0c ea ff ff       	call   8000b0 <sys_cputs>
}
  8016a4:	c9                   	leave  
  8016a5:	c3                   	ret    
...
opencons(void)
{
  ...
  801738:	e8 40 ea ff ff       	call   80017d <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801777:	e8 c3 e9 ff ff       	call   80013f <sys_getenvid>
  ...
  801792:	c7 04 24 40 27 80 00 	movl   $0x802740,(%esp)
  ...
  8017a8:	e8 51 00 00 00       	call   8017fe <vcprintf>
	cprintf("\n");
  8017ad:	c7 04 24 2c 27 80 00 	movl   $0x80272c,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  8017e9:	e8 c2 e8 ff ff       	call   8000b0 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801852:	e8 59 e8 ff ff       	call   8000b0 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801958:	0f be 80 63 27 80 00 	movsbl 0x802763(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801b1f:	c7 44 24 08 7b 27 80 	movl   $0x80277b,0x8(%esp)
  801b26:	00 
  ...
  801b3f:	c7 44 24 08 c1 26 80 	movl   $0x8026c1,0x8(%esp)
  801b46:	00 
  ...
  801b71:	b8 74 27 80 00       	mov    $0x802774,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8021fe:	e8 90 e1 ff ff       	call   800393 <sys_ipc_recv>
  ...
  80221b:	eb 36                	jmp    802253 <ipc_recv+0x73>
	...
	thisenv = &envs[ENVX(sys_getenvid())];
  80221d:	e8 1d df ff ff       	call   80013f <sys_getenvid>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802288:	e8 e3 e0 ff ff       	call   800370 <sys_ipc_try_send>
  ...
  8022b1:	e8 b0 f4 ff ff       	call   801766 <_panic>
		...
		sys_yield();
  8022b6:	e8 a3 de ff ff       	call   80015e <sys_yield>
	}
