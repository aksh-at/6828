...
exit(void)
{
  ...
  800089:	83 ec 18             	sub    $0x18,%esp
	close_all();
  80008c:	e8 e9 05 00 00       	call   80067a <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  800109:	00 
  80010a:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  800111:	00 
  800112:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800119:	00 
  80011a:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  800121:	e8 30 16 00 00       	call   801756 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80019b:	00 
  80019c:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  8001a3:	00 
  8001a4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001ab:	00 
  8001ac:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  8001b3:	e8 9e 15 00 00       	call   801756 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001ee:	00 
  8001ef:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  8001f6:	00 
  8001f7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001fe:	00 
  8001ff:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  800206:	e8 4b 15 00 00       	call   801756 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800241:	00 
  800242:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  800249:	00 
  80024a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800251:	00 
  800252:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  800259:	e8 f8 14 00 00       	call   801756 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800294:	00 
  800295:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  80029c:	00 
  80029d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002a4:	00 
  8002a5:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  8002ac:	e8 a5 14 00 00       	call   801756 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002e7:	00 
  8002e8:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  8002ef:	00 
  8002f0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002f7:	00 
  8002f8:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  8002ff:	e8 52 14 00 00       	call   801756 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80033a:	00 
  80033b:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  800342:	00 
  800343:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80034a:	00 
  80034b:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  800352:	e8 ff 13 00 00       	call   801756 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003af:	00 
  8003b0:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  8003b7:	00 
  8003b8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003bf:	00 
  8003c0:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  8003c7:	e8 8a 13 00 00       	call   801756 <_panic>
...
sys_try_send_packet(void* packetva, int size)
{
  ...
  800414:	7e 28                	jle    80043e <sys_try_send_packet+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800416:	89 44 24 10          	mov    %eax,0x10(%esp)
  80041a:	c7 44 24 0c 0f 00 00 	movl   $0xf,0xc(%esp)
  800421:	00 
  800422:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  800429:	00 
  80042a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800431:	00 
  800432:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  800439:	e8 18 13 00 00       	call   801756 <_panic>
...
sys_try_recv_packet(void** packet_dst, int* size_store)
{
  ...
  800467:	7e 28                	jle    800491 <sys_try_recv_packet+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800469:	89 44 24 10          	mov    %eax,0x10(%esp)
  80046d:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
  800474:	00 
  800475:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  80047c:	00 
  80047d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800484:	00 
  800485:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  80048c:	e8 c5 12 00 00       	call   801756 <_panic>
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800639:	e8 d5 fb ff ff       	call   800213 <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800737:	e8 84 fa ff ff       	call   8001c0 <sys_page_map>
  ...
  800772:	e8 49 fa ff ff       	call   8001c0 <sys_page_map>
...
err:
  ...
  80078b:	e8 83 fa ff ff       	call   800213 <sys_page_unmap>
...
alloc_sockfd(int sockid)
{
  ...
  800e2c:	e8 3b f3 ff ff       	call   80016c <sys_page_alloc>
...
devpipe_close(struct Fd *fd)
{
  ...
  801290:	e8 7e ef ff ff       	call   800213 <sys_page_unmap>
  ...
  8012a8:	e8 66 ef ff ff       	call   800213 <sys_page_unmap>
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801344:	75 41                	jne    801387 <devpipe_write+0x6b>
			...
			sys_yield();
  801346:	e8 02 ee ff ff       	call   80014d <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8013c4:	75 31                	jne    8013f7 <devpipe_read+0x63>
			...
			sys_yield();
  8013c6:	e8 82 ed ff ff       	call   80014d <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  801437:	e8 30 ed ff ff       	call   80016c <sys_page_alloc>
  ...
  801471:	e8 f6 ec ff ff       	call   80016c <sys_page_alloc>
  ...
  8014a0:	e8 c7 ec ff ff       	call   80016c <sys_page_alloc>
  ...
  8014d9:	e8 e2 ec ff ff       	call   8001c0 <sys_page_map>
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  80161d:	e8 7d ea ff ff       	call   80009f <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801647:	eb 2a                	jmp    801673 <devcons_read+0x3d>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801649:	e8 ff ea ff ff       	call   80014d <sys_yield>
	int c;
  ...
  801650:	e8 68 ea ff ff       	call   8000bd <sys_cgetc>
...
cputchar(int ch)
{
  ...
  80168f:	e8 0b ea ff ff       	call   80009f <sys_cputs>
}
  801694:	c9                   	leave  
  801695:	c3                   	ret    
...
opencons(void)
{
  ...
  801728:	e8 3f ea ff ff       	call   80016c <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801767:	e8 c2 e9 ff ff       	call   80012e <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  8017d9:	e8 c1 e8 ff ff       	call   80009f <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801842:	e8 58 e8 ff ff       	call   80009f <sys_cputs>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8021ee:	e8 8f e1 ff ff       	call   800382 <sys_ipc_recv>
  ...
  80220b:	eb 36                	jmp    802243 <ipc_recv+0x73>
	...
	thisenv = &envs[ENVX(sys_getenvid())];
  80220d:	e8 1c df ff ff       	call   80012e <sys_getenvid>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802278:	e8 e2 e0 ff ff       	call   80035f <sys_ipc_try_send>
  ...
  8022a1:	e8 b0 f4 ff ff       	call   801756 <_panic>
		...
		sys_yield();
  8022a6:	e8 a2 de ff ff       	call   80014d <sys_yield>
	}
