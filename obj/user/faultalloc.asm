...
handler(struct UTrapframe *utf)
{
  ...
  80007a:	c7 44 24 08 e0 11 80 	movl   $0x8011e0,0x8(%esp)
  800081:	00 
  800082:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  800089:	00 
  80008a:	c7 04 24 ca 11 80 00 	movl   $0x8011ca,(%esp)
  800091:	e8 ba 00 00 00       	call   800150 <_panic>
	snprintf((char*) addr, 100, "this string was faulted in at %x", addr);
  800096:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  80009a:	c7 44 24 08 0c 12 80 	movl   $0x80120c,0x8(%esp)
  8000a1:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80017c:	c7 04 24 38 12 80 00 	movl   $0x801238,(%esp)
  ...
  800192:	e8 51 00 00 00       	call   8001e8 <vcprintf>
	cprintf("\n");
  800197:	c7 04 24 de 11 80 00 	movl   $0x8011de,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002df:	e8 3c 0c 00 00       	call   800f20 <__udivdi3>
  ...
  80033f:	e8 0c 0d 00 00       	call   801050 <__umoddi3>
  800344:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800348:	0f be 80 5c 12 80 00 	movsbl 0x80125c(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800463:	ff 24 8d 20 13 80 00 	jmp    *0x801320(,%ecx,4)
  ...
  80052f:	c7 44 24 08 7d 12 80 	movl   $0x80127d,0x8(%esp)
  800536:	00 
  ...
  800561:	b8 6d 12 80 00       	mov    $0x80126d,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c30:	00 
  800c31:	c7 44 24 08 a4 14 80 	movl   $0x8014a4,0x8(%esp)
  800c38:	00 
  800c39:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c40:	00 
  800c41:	c7 04 24 c1 14 80 00 	movl   $0x8014c1,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800cc2:	00 
  800cc3:	c7 44 24 08 a4 14 80 	movl   $0x8014a4,0x8(%esp)
  800cca:	00 
  800ccb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cd2:	00 
  800cd3:	c7 04 24 c1 14 80 00 	movl   $0x8014c1,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d15:	00 
  800d16:	c7 44 24 08 a4 14 80 	movl   $0x8014a4,0x8(%esp)
  800d1d:	00 
  800d1e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d25:	00 
  800d26:	c7 04 24 c1 14 80 00 	movl   $0x8014c1,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d68:	00 
  800d69:	c7 44 24 08 a4 14 80 	movl   $0x8014a4,0x8(%esp)
  800d70:	00 
  800d71:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d78:	00 
  800d79:	c7 04 24 c1 14 80 00 	movl   $0x8014c1,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800dbb:	00 
  800dbc:	c7 44 24 08 a4 14 80 	movl   $0x8014a4,0x8(%esp)
  800dc3:	00 
  800dc4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dcb:	00 
  800dcc:	c7 04 24 c1 14 80 00 	movl   $0x8014c1,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e0e:	00 
  800e0f:	c7 44 24 08 a4 14 80 	movl   $0x8014a4,0x8(%esp)
  800e16:	00 
  800e17:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e1e:	00 
  800e1f:	c7 04 24 c1 14 80 00 	movl   $0x8014c1,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e83:	00 
  800e84:	c7 44 24 08 a4 14 80 	movl   $0x8014a4,0x8(%esp)
  800e8b:	00 
  800e8c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e93:	00 
  800e94:	c7 04 24 c1 14 80 00 	movl   $0x8014c1,(%esp)
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800eab:	53                   	push   %ebx
  800eac:	83 ec 14             	sub    $0x14,%esp
	int r;

	if (_pgfault_handler == 0) {
  800eaf:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  800eb6:	75 2f                	jne    800ee7 <set_pgfault_handler+0x3f>
		// First time through!
		// LAB 4: Your code here.
		envid_t envid = sys_getenvid();
  800eb8:	e8 98 fd ff ff       	call   800c55 <sys_getenvid>
  800ebd:	89 c3                	mov    %eax,%ebx
		sys_page_alloc(envid, (void *)(UXSTACKTOP - PGSIZE), PTE_U|PTE_W|PTE_P);
  800ebf:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  800ec6:	00 
  800ec7:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  800ece:	ee 
  800ecf:	89 04 24             	mov    %eax,(%esp)
  800ed2:	e8 bc fd ff ff       	call   800c93 <sys_page_alloc>
		sys_env_set_pgfault_upcall(envid, (void *)_pgfault_upcall);
  800ed7:	c7 44 24 04 f5 0e 80 	movl   $0x800ef5,0x4(%esp)
  800ede:	00 
  800edf:	89 1c 24             	mov    %ebx,(%esp)
  800ee2:	e8 f9 fe ff ff       	call   800de0 <sys_env_set_pgfault_upcall>
	}
  ...
  800eef:	83 c4 14             	add    $0x14,%esp
  800ef2:	5b                   	pop    %ebx
  800ef3:	5d                   	pop    %ebp
  800ef4:	c3                   	ret    

00800ef5 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  800efd:	83 c4 04             	add    $0x4,%esp
	...
	subl $4, 0x30(%esp)
  800f00:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
	movl 0x30(%esp), %eax 
  800f05:	8b 44 24 30          	mov    0x30(%esp),%eax
	movl 0x28(%esp), %ebp
  800f09:	8b 6c 24 28          	mov    0x28(%esp),%ebp
	movl %ebp, (%eax)
  800f0d:	89 28                	mov    %ebp,(%eax)
