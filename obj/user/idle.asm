...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  800039:	c7 05 00 30 80 00 e0 	movl   $0x8025e0,0x803000
  800040:	25 80 00 
...
exit(void)
{
  ...
  800095:	83 ec 18             	sub    $0x18,%esp
	close_all();
  800098:	e8 ed 05 00 00       	call   80068a <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  800115:	00 
  800116:	c7 44 24 08 ef 25 80 	movl   $0x8025ef,0x8(%esp)
  80011d:	00 
  80011e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800125:	00 
  800126:	c7 04 24 0c 26 80 00 	movl   $0x80260c,(%esp)
  80012d:	e8 34 16 00 00       	call   801766 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001a7:	00 
  8001a8:	c7 44 24 08 ef 25 80 	movl   $0x8025ef,0x8(%esp)
  8001af:	00 
  8001b0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001b7:	00 
  8001b8:	c7 04 24 0c 26 80 00 	movl   $0x80260c,(%esp)
  8001bf:	e8 a2 15 00 00       	call   801766 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001fa:	00 
  8001fb:	c7 44 24 08 ef 25 80 	movl   $0x8025ef,0x8(%esp)
  800202:	00 
  800203:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80020a:	00 
  80020b:	c7 04 24 0c 26 80 00 	movl   $0x80260c,(%esp)
  800212:	e8 4f 15 00 00       	call   801766 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80024d:	00 
  80024e:	c7 44 24 08 ef 25 80 	movl   $0x8025ef,0x8(%esp)
  800255:	00 
  800256:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80025d:	00 
  80025e:	c7 04 24 0c 26 80 00 	movl   $0x80260c,(%esp)
  800265:	e8 fc 14 00 00       	call   801766 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002a0:	00 
  8002a1:	c7 44 24 08 ef 25 80 	movl   $0x8025ef,0x8(%esp)
  8002a8:	00 
  8002a9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002b0:	00 
  8002b1:	c7 04 24 0c 26 80 00 	movl   $0x80260c,(%esp)
  8002b8:	e8 a9 14 00 00       	call   801766 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002f3:	00 
  8002f4:	c7 44 24 08 ef 25 80 	movl   $0x8025ef,0x8(%esp)
  8002fb:	00 
  8002fc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800303:	00 
  800304:	c7 04 24 0c 26 80 00 	movl   $0x80260c,(%esp)
  80030b:	e8 56 14 00 00       	call   801766 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800346:	00 
  800347:	c7 44 24 08 ef 25 80 	movl   $0x8025ef,0x8(%esp)
  80034e:	00 
  80034f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800356:	00 
  800357:	c7 04 24 0c 26 80 00 	movl   $0x80260c,(%esp)
  80035e:	e8 03 14 00 00       	call   801766 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003bb:	00 
  8003bc:	c7 44 24 08 ef 25 80 	movl   $0x8025ef,0x8(%esp)
  8003c3:	00 
  8003c4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003cb:	00 
  8003cc:	c7 04 24 0c 26 80 00 	movl   $0x80260c,(%esp)
  8003d3:	e8 8e 13 00 00       	call   801766 <_panic>
...
sys_time_msec(void)
{
  ...
  8003f0:	89 d1                	mov    %edx,%ecx
  8003f2:	89 d3                	mov    %edx,%ebx
...
sys_try_send_packet(void* packetva, int size)
{
  ...
  800420:	7e 28                	jle    80044a <sys_try_send_packet+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800422:	89 44 24 10          	mov    %eax,0x10(%esp)
  800426:	c7 44 24 0c 0f 00 00 	movl   $0xf,0xc(%esp)
  80042d:	00 
  80042e:	c7 44 24 08 ef 25 80 	movl   $0x8025ef,0x8(%esp)
  800435:	00 
  800436:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80043d:	00 
  80043e:	c7 04 24 0c 26 80 00 	movl   $0x80260c,(%esp)
  800445:	e8 1c 13 00 00       	call   801766 <_panic>
...
sys_try_recv_packet(void** packet_dst, int* size_store)
{
  ...
  800473:	7e 28                	jle    80049d <sys_try_recv_packet+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800475:	89 44 24 10          	mov    %eax,0x10(%esp)
  800479:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
  800480:	00 
  800481:	c7 44 24 08 ef 25 80 	movl   $0x8025ef,0x8(%esp)
  800488:	00 
  800489:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800490:	00 
  800491:	c7 04 24 0c 26 80 00 	movl   $0x80260c,(%esp)
  800498:	e8 c9 12 00 00       	call   801766 <_panic>
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80059f:	8b 04 95 98 26 80 00 	mov    0x802698(,%edx,4),%eax
  ...
  8005ba:	c7 04 24 1c 26 80 00 	movl   $0x80261c,(%esp)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800649:	e8 d1 fb ff ff       	call   80021f <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800747:	e8 80 fa ff ff       	call   8001cc <sys_page_map>
  ...
  800782:	e8 45 fa ff ff       	call   8001cc <sys_page_map>
...
err:
  ...
  80079b:	e8 7f fa ff ff       	call   80021f <sys_page_unmap>
	sys_page_unmap(0, nva);
  8007a0:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8007a4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8007ab:	e8 6f fa ff ff       	call   80021f <sys_page_unmap>
	return r;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80080f:	c7 04 24 5d 26 80 00 	movl   $0x80265d,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8008e7:	c7 04 24 79 26 80 00 	movl   $0x802679,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8009a0:	c7 04 24 3c 26 80 00 	movl   $0x80263c,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800c24:	c7 44 24 0c ac 26 80 	movl   $0x8026ac,0xc(%esp)
  800c2b:	00 
  800c2c:	c7 44 24 08 b3 26 80 	movl   $0x8026b3,0x8(%esp)
  800c33:	00 
  800c34:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  800c3b:	00 
  800c3c:	c7 04 24 c8 26 80 00 	movl   $0x8026c8,(%esp)
  800c43:	e8 1e 0b 00 00       	call   801766 <_panic>
	assert(r <= PGSIZE);
  800c48:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800c4d:	7e 24                	jle    800c73 <devfile_read+0x84>
  800c4f:	c7 44 24 0c d3 26 80 	movl   $0x8026d3,0xc(%esp)
  800c56:	00 
  800c57:	c7 44 24 08 b3 26 80 	movl   $0x8026b3,0x8(%esp)
  800c5e:	00 
  800c5f:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  800c66:	00 
  800c67:	c7 04 24 c8 26 80 00 	movl   $0x8026c8,(%esp)
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800d36:	c7 44 24 04 df 26 80 	movl   $0x8026df,0x4(%esp)
  800d3d:	00 
...
fd2sockid(int fd)
{
  ...
  800df5:	8b 0d 20 30 80 00    	mov    0x803020,%ecx
...
alloc_sockfd(int sockid)
{
  ...
  800e3c:	e8 37 f3 ff ff       	call   800178 <sys_page_alloc>
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801157:	c7 44 24 0c eb 26 80 	movl   $0x8026eb,0xc(%esp)
  80115e:	00 
  80115f:	c7 44 24 08 b3 26 80 	movl   $0x8026b3,0x8(%esp)
  801166:	00 
  801167:	c7 44 24 04 62 00 00 	movl   $0x62,0x4(%esp)
  80116e:	00 
  80116f:	c7 04 24 00 27 80 00 	movl   $0x802700,(%esp)
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  8011b5:	c7 44 24 0c 0c 27 80 	movl   $0x80270c,0xc(%esp)
  8011bc:	00 
  8011bd:	c7 44 24 08 b3 26 80 	movl   $0x8026b3,0x8(%esp)
  8011c4:	00 
  8011c5:	c7 44 24 04 6d 00 00 	movl   $0x6d,0x4(%esp)
  8011cc:	00 
  8011cd:	c7 04 24 00 27 80 00 	movl   $0x802700,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801250:	c7 44 24 04 18 27 80 	movl   $0x802718,0x4(%esp)
  801257:	00 
  ...
  801272:	00 00 00 
	stat->st_dev = &devpipe;
  801275:	c7 83 88 00 00 00 3c 	movl   $0x80303c,0x88(%ebx)
  80127c:	30 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  8012a0:	e8 7a ef ff ff       	call   80021f <sys_page_unmap>
  ...
  8012b8:	e8 62 ef ff ff       	call   80021f <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801316:	c7 04 24 1f 27 80 00 	movl   $0x80271f,(%esp)
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801354:	75 41                	jne    801397 <devpipe_write+0x6b>
			...
			sys_yield();
  801356:	e8 fe ed ff ff       	call   800159 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8013d4:	75 31                	jne    801407 <devpipe_read+0x63>
			...
			sys_yield();
  8013d6:	e8 7e ed ff ff       	call   800159 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  801447:	e8 2c ed ff ff       	call   800178 <sys_page_alloc>
  ...
  801481:	e8 f2 ec ff ff       	call   800178 <sys_page_alloc>
  ...
  8014b0:	e8 c3 ec ff ff       	call   800178 <sys_page_alloc>
  ...
  8014e9:	e8 de ec ff ff       	call   8001cc <sys_page_map>
  ...
  8014f4:	8b 15 3c 30 80 00    	mov    0x80303c,%edx
  ...
  801509:	8b 15 3c 30 80 00    	mov    0x80303c,%edx
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8015d0:	c7 44 24 04 37 27 80 	movl   $0x802737,0x4(%esp)
  8015d7:	00 
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  80162d:	e8 79 ea ff ff       	call   8000ab <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801657:	eb 2a                	jmp    801683 <devcons_read+0x3d>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801659:	e8 fb ea ff ff       	call   800159 <sys_yield>
	int c;
  ...
  801660:	e8 64 ea ff ff       	call   8000c9 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  80169f:	e8 07 ea ff ff       	call   8000ab <sys_cputs>
}
  8016a4:	c9                   	leave  
  8016a5:	c3                   	ret    
...
iscons(int fdnum)
{
  ...
  8016fb:	8b 15 58 30 80 00    	mov    0x803058,%edx
...
opencons(void)
{
  ...
  801738:	e8 3b ea ff ff       	call   800178 <sys_page_alloc>
		return r;
  ...
  801743:	8b 15 58 30 80 00    	mov    0x803058,%edx
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801771:	8b 35 00 30 80 00    	mov    0x803000,%esi
  801777:	e8 be e9 ff ff       	call   80013a <sys_getenvid>
  ...
  801792:	c7 04 24 44 27 80 00 	movl   $0x802744,(%esp)
  ...
  8017a8:	e8 51 00 00 00       	call   8017fe <vcprintf>
	cprintf("\n");
  8017ad:	c7 04 24 30 27 80 00 	movl   $0x802730,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  8017e9:	e8 bd e8 ff ff       	call   8000ab <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801852:	e8 54 e8 ff ff       	call   8000ab <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801958:	0f be 80 67 27 80 00 	movsbl 0x802767(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801a73:	ff 24 8d a0 28 80 00 	jmp    *0x8028a0(,%ecx,4)
  ...
  801b3f:	c7 44 24 08 c5 26 80 	movl   $0x8026c5,0x8(%esp)
  801b46:	00 
  ...
  801b71:	b8 78 27 80 00       	mov    $0x802778,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8021fe:	e8 8b e1 ff ff       	call   80038e <sys_ipc_recv>
  ...
  80221b:	eb 36                	jmp    802253 <ipc_recv+0x73>
	...
	thisenv = &envs[ENVX(sys_getenvid())];
  80221d:	e8 18 df ff ff       	call   80013a <sys_getenvid>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802288:	e8 de e0 ff ff       	call   80036b <sys_ipc_try_send>
  ...
  80229a:	c7 44 24 08 60 2a 80 	movl   $0x802a60,0x8(%esp)
  8022a1:	00 
  8022a2:	c7 44 24 04 41 00 00 	movl   $0x41,0x4(%esp)
  8022a9:	00 
  8022aa:	c7 04 24 90 2a 80 00 	movl   $0x802a90,(%esp)
  8022b1:	e8 b0 f4 ff ff       	call   801766 <_panic>
		}
		sys_yield();
  8022b6:	e8 9e de ff ff       	call   800159 <sys_yield>
	}
