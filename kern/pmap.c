...
mem_init(void)
{
	...
	//boot_map_region(kern_pgdir, UPAGES, ROUNDUP(sizeof(pages),PGSIZE), PADDR(pages), PTE_U | PTE_P);
	//////////////////////////////////////////////////////////////////////
	...
	//boot_map_region(kern_pgdir, KSTACKTOP-PTSIZE, PTSIZE- KSTKSIZE, NULL, PTE_P);
